<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_JJ_EDIT_STAFF_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_JJ_EDIT_STAFF_CONFIRM" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            <div class="row" runat="server" id="KEEP_PAY" visible="true">
                ...
                <div class="row" runat="server" id="PS1" visible="false">
                    <div class="col-lg-1"></div>
                    <div class="col-lg-4">ตำแหน่ง จนท.ที่รับผิดชอบ</div>
                    <div class="col-lg-6">
                ...
                <div class="row" runat="server" id="OE1" visible="false">
                    <div class="col-lg-1"></div>
                    <div class="col-lg-4">คำสั่งอื่น</div>
                    <div class="col-lg-6">
                        <asp:DropDownList ID="DD_OTHER_REQUEST" runat="server" DataValueField="OTHER_REQUEST_ID" DataTextField="OTHER_REQUEST_NAME" Width="100%"></asp:DropDownList>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
                <div class="row" runat="server" id="OE2" visible="false">
                    <div class="col-lg-1"></div>
            ...
            <%--  <---------------------------------------- PDF JJ3 ---------------------------------------------->--%>
            <div id="pdf_approve_jj3" runat="server" visible="false">
                <div class="row">
                    <div class="col-lg-12" style="text-align: center">
                        <h3>อัพโหลดเอกสาร จจ.3 ที่อนุมัติแล้ว</h3>
                    </div>
                </div>
                ...
                <div class="row" runat="server" id="uc_upload1_btn" visible="true">
                    <div class="col-lg-12" style="text-align: center">
                        <asp:Button ID="btn_savefileapprove_jj3" runat="server" Text="บันทึกแบบไฟล์" CssClass="btn-lg" Width="80%" />
                    </div>
                </div>
                <div class="row" runat="server" id="uc_upload2_radgrid" visible="false">
                    <div class="col-lg-1"></div>
