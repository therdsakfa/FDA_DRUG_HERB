<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_DRUG_PRODUCT_ID_INSERT_AND_UPDATE.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_DRUG_PRODUCT_ID_INSERT_AND_UPDATE" %>
