<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCT_ID.Master" CodeBehind="FRM_DRUG_PRODUCT_ID_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DRUG_PRODUCT_ID_MAIN" %>
...
<ItemStyle Width="10%"></ItemStyle>
        ...
        <asp:TemplateField>
            <ItemTemplate>
                       <asp:Button ID="btn_del" runat="server"  Text="ลบ" CommandName="del" Width="100%" CssClass="btn-link" OnClientClick="return confirm('ต้องการลบหรือไม่');" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' />
                   </ItemTemplate>
            </asp:TemplateField>
         <asp:TemplateField >
