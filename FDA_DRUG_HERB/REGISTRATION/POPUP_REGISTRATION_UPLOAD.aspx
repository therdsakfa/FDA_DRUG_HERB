<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_REGISTRATION_UPLOAD.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_REGISTRATION_UPLOAD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table" style="width:100%">
        <tr ><td style="width:20%"> <asp:Label ID="Label1" runat="server" Text="บัญชีรายการขอขึ้นทะเบียนยา"></asp:Label> </td>
