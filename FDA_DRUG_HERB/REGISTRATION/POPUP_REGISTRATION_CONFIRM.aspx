<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_REGISTRATION_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_REGISTRATION_CONFIRM" %>
        ...
        <tr>
            ...
            <td style="padding-left: 10%; height: 50%;">
                ...
                <table class="table" style="width: 90%">
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btn_confirm" runat="server" Text="สร้างตำรับ" CssClass="btn-lg" Width="80%" OnClientClick="return confirm('ต้องการส่งข้อมูลหรือไม่');" /></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btn_load" runat="server" Text="ดูด้วย Reader" CssClass="btn-lg" Width="80%" /></td>
                    </tr>
                    <tr>
                        <td>
