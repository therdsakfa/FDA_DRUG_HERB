<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_REGISTRATION_DETAIL_OTHER.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_REGISTRATION_DETAIL_OTHER" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" MultiPageID="RadMultiPage1" Orientation="HorizontalTop">
        <Tabs>
            ...
            <%--<telerik:RadTab runat="server" Text="9.ข้อมูลยาสัตว์" Value="11" Visible ="false">
            </telerik:RadTab>--%>
        </Tabs>
    </telerik:RadTabStrip>
 <table class="table" width="80%">
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="fa left">
        ...
        <%--<telerik:RadPageView ID="RadPageView10" runat="server" TabIndex="11" style="display:none;">
