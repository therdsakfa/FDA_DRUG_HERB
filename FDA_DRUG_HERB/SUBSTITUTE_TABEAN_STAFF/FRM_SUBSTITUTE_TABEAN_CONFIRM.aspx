<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_SUBSTITUTE_TABEAN_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_SUBSTITUTE_TABEAN_CONFIRM" %>
                ...
                <table class="table" style="width: 90%">
                    ...
                    <tr>
                        <td>
                         ...
                         <tr>
                            <td>
                                <asp:Label ID="Label4" runat="server" Text="จนท.ที่รับผิดชอบ:"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
