...
Public Class FRM_HERB_TABEAN_JJ_EDIT_SELECT_LCN
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.NavigateUrl = "../HERB_TABEAN_JJ_EDIT/FRM_HERB_TABEAN_JJ_EDIT_MAIN.aspx?IDA_LCN=" & IDA_LCN & "&SID=" & _SID & "&PROCESS_ID=" & Request.QueryString("process_id") 'URL หน้า ยืนยัน
