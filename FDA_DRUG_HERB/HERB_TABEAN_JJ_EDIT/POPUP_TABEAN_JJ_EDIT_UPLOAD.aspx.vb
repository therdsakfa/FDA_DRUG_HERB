Public Class POPUP_TABEAN_JJ_EDIT_UPLOAD
    ...
    Sub alert_normal(ByVal text As String)
        Dim url As String = ""
        url = "FRM_HERB_TABEAN_JJ_EDIT_COMFIRM.aspx?IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA & "&IDA_JJ=" & IDA_JJ
    ...
    Sub alert_file_error(ByVal text As String)
        Dim url As String = ""
        url = "POPUP_TABEAN_JJ_EDIT_UPLOAD.aspx?&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA & "&identify=" & Request.QueryString("identify")
