<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_Product.Master" MaintainScrollPositionOnPostback="true" CodeBehind="FRM_HERB_TABEAN_JJ_EDIT_ADD.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_JJ_EDIT_ADD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" id="TN1" runat="server" >
        <div class="col-lg-1"></div>
        <div class="col-lg-2">
            <label>โดยมีผู้ดำเนินกิจการชื่อ:</label>
        </div>
        <div class="col-lg-4" style="border-bottom: #999999 1px dotted; text-align: center">
  ...
  <%--  <hr />--%>
    <div class="row" id="E1" runat="server">
        <div class="col-lg-12" style="text-align: center">
            ...
            <asp:Button ID="btn_save" runat="server" Text="บันทึกส่วนที่ 1" Height="40px" Width="135px" />
        </div>
    </div>
</asp:Content>
