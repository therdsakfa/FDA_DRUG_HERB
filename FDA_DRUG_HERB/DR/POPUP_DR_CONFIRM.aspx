<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_DR_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_DR_CONFIRM" %>
...
&nbsp;<%--<asp:DropDownList ID="ddl_req_type" runat="server" CssClass="btn-lg"   Width="80%">
                             </asp:DropDownList>--%>
                     ...
                     <tr><td><asp:Button ID="btn_confirm" runat="server" Text="ยื่นคำขอ" CssClass="btn-lg"   Width="80%" OnClientClick="confirm('ต้องการยืนยันหรือไม่');" /></td></tr>
                     <tr><td> <asp:Button ID="btn_cancel" runat="server" Text="ยกเลิก" CssClass="btn-lg"   Width="80%" OnClientClick="confirm('ต้องการยกเลิกหรือไม่');"/></td></tr>
