...
Public Class POPUP_DR_CONFIRM
    ...
    Private Sub BindData_PDF_SAI(ByVal newcode As String)
        ...
        Dim dao_pdftemplate As New DAO_DRUG.ClsDB_MAS_TEMPLATE_PROCESS
        dao_pdftemplate.GetDataby_TEMPLAETE_and_P_ID_and_STATUS_and_PREVIEW_AND_GROUP(_ProcessID, STATUS_ID, 0, 0)
        '------------------------(E)------------------------
        Dim E_VALUE As String = ""
        Dim dao_drgtpcd As New DAO_DRUG.ClsDBdrdrgtype
        Try
        ...
        If E_VALUE <> "(E)" Then
            ...
            If Request.QueryString("STATUS_ID") = "14" Or Request.QueryString("STATUS_ID") = "18" Then
                If rgttpcd = "G" Or rgttpcd = "H" Or rgttpcd = "K" Then
                    NAME_TEMPLATE = "DA_YOR_2_1.pdf"
                End If
            End If
