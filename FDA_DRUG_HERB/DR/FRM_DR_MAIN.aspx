<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NODE.Master" CodeBehind="FRM_DR_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DR_MAIN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div>
     ...
     <asp:GridView ID="GV_data" DataKeyNames="IDA" runat="server" Width="100%" CssClass="table" CellPadding="4" ForeColor="#333333"
           ...
           <Columns>
              <%-- <asp:BoundField DataField="cnsdcd" HeaderText="cnsdcd" ItemStyle-Width="10%" >
