<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_Auto_Menu.Master" CodeBehind="FRM_CHANGE_BSN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_CHANGE_BSN" %>
                   ...
                   <td>
                       <asp:GridView ID="GV_data" DataKeyNames="IDA" runat="server" Width="100%" CssClass="table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                           ...
                           <Columns>
                              ...
                              <asp:BoundField DataField="REMARK" HeaderText="รายละเอียด" ItemStyle-Width="30%">
