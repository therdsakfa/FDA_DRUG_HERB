<%@ Page Title="" Language="vb" AutoEventWireup="false"MasterPageFile="~/MasterPage/Main_Auto_Menu.Master" CodeBehind="FRM_EDIT_LOCATION_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_EDIT_LOCATION_MAIN" %>
                   ...
                   <td>
                       <asp:GridView ID="GV_data" DataKeyNames="IDA" runat="server" Width="100%" CssClass="table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                           ...
                           <Columns>
                              ...
                              <asp:BoundField DataField="REMARK" HeaderText="ขอเปลี่ยนแปลง" ItemStyle-Width="10%">
                                   <ItemStyle Width="10%"></ItemStyle>
                               </asp:BoundField>
