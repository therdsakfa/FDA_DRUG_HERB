<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_CHANGE_BSN_INSERT_AND_UPDATE.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_CHANGE_BSN_INSERT_AND_UPDATE" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel" style="width:100%">
          <div class="panel-heading panel-title">
                <h1>คำขอเปลี่ยนผู้รับอนุญาต</h1>
            </div>
