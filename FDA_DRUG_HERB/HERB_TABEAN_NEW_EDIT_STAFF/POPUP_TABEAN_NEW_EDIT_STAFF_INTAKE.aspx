<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_TABEAN_NEW_EDIT_STAFF_INTAKE.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_TABEAN_NEW_EDIT_STAFF_INTAKE" %>
            ...
            <div runat="server" id="Submit_BG" style="border-radius: 5px; padding: 2em; background-color: white;">
                <div class="row" runat="server" id="KEEP_PAY" visible="true">
                    ...
                    <div runat="server" id="Div_Process" visible="false">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <asp:DropDownList ID="DD_PROCESS_ID" runat="server" BackColor="White" Height="25px" Width="100%" SkinID="bootstrap" Enabled="true">
                                    <asp:ListItem Value="0">-- กรุณาเลือก --</asp:ListItem>
                                    <asp:ListItem Value="20411">ระดับหลัก </asp:ListItem>
                                    <asp:ListItem Value="20412">ระดับรอง</asp:ListItem>
                ...
                <div class="row" runat="server" id="p2" visible="false">
                    ...
                    <div class="row" runat="server">
                        ...
                        <div class="col-lg-4">
                            เนื่องจาก
                        <asp:Label ID="lbl_chk_ddlcc" ForeColor="Red" Visible="false" runat="server" Text="*กรุณาเลือก"></asp:Label>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row" style="text-align: center">
                    ...
                    <div class="col-lg-10">
                        ...
                        <asp:Button ID="btn_keep_pay" runat="server" Text="ข้ามสถานะ" CssClass="btn-lg bg-warning" Width="100%" Visible="false" />
                        <div style="padding-top: 10px"></div>
                        <asp:Button ID="btn_upload_file" runat="server" Text="แนบเอกสารเพิ่ม" CssClass="btn-lg bg-warning" Width="100%" />
                        <div style="padding-top: 10px"></div>
