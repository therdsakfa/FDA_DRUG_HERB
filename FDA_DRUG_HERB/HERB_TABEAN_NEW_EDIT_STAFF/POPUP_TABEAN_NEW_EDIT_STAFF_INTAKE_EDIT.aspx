<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_TABEAN_NEW_EDIT_STAFF_INTAKE_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_TABEAN_NEW_EDIT_STAFF_INTAKE_EDIT" %>
            ...
            <div runat="server" id="Submit_BG" style="border-radius: 5px; padding: 2em; background-color: white;">
                ...
                <div class="row" style="text-align: center">
                    ...
                    <div class="col-lg-10">
                        ...
                        <asp:Button ID="btn_keep_pay" runat="server" Text="ข้ามสถานะ" CssClass="btn-lg bg-primary" Width="100%" Visible="false" />
                        <div style="padding-top: 10px"></div>
