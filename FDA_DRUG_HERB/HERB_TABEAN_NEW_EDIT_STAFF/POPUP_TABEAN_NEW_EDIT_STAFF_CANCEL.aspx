<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_TABEAN_NEW_EDIT_STAFF_CANCEL.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_TABEAN_NEW_EDIT_STAFF_CANCEL" %>
    ...
    <div class="panel" style="width: 100%">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-2" style="text-align: right; padding-right: 2em">
            ...
            <div class="row">
                <div class="col-lg-4"></div>
                <div class="col-lg-2" style="text-align: right; padding-right: 2em">
                    <asp:Label ID="Label4" runat="server" Text="รายละเอียดการยกเลิก(ถ้ามี) : " Font-Size="Medium"></asp:Label>
                </div>
                <div class="col-lg-4">
