...
Public Class POPUP_NORYORMOR1_CONFIRM
    ...
    Private Sub BindData_PDF()
        ...
        Dim cls_regis As New CLASS_GEN_XML.DI(_CLS.CITIZEN_ID, dao.fields.lcnsid, dao_lcn.fields.lcnno, _
                                              IIf(IsDBNull(dao_lcn.fields.lcntpcd), 0, dao_lcn.fields.lcntpcd), dao.fields.pvncd, dao_lcn.fields.IDA)
