<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_LCN_IMPORT_UPLOAD_ATTACH.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_LCN_IMPORT_UPLOAD_ATTACH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <img src="../imgs/spinner.gif" alt="Loading" style="position: absolute; top: 120px; left: 293px; height: 185px; width: 207px;" />
     ...
     <div style="width:100% ; text-align:left"  >
         ...
         <table class="table"> <tr><td class="auto-style1">   ใบคำขอ</td><td class="auto-style2">   <asp:FileUpload ID="FileUpload1" runat="server" CssClass="btn-default" />  </td></tr>
             <tr><td colspan="2">
                 <!-- ขย.1 --> 
             ...
             <tr><td colspan="2"> <asp:Button ID="btn_Upload" runat="server" Text="อัพโหลด"   CssClass=" btn-lg" />
                 ...
                 <asp:Button ID="Button2" runat="server" Text="ย้อนกลับ" CssClass=" btn-lg" Width="150px" />
                 </td></tr>
