<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_RGT_EDIT_CHECK_RQT_SSP.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_RGT_EDIT_CHECK_RQT_SSP" %>
                ...
                <table class="table">
                 ...
                 <%--  <tr ><td>ผู้รับคำขอ</td><td>
                  ...
                  <%-- <tr ><td>จนท.ผู้รับคำขอ</td><td>
                   ...
                   <tr ><td class="auto-style1">เลขรับคำขอ</td><td class="auto-style1">
                        <asp:TextBox ID="txt_rcvno" runat="server" CssClass="input-lg"></asp:TextBox>
                        &nbsp;(ตัวอย่าง 15111/63)</td></tr>
