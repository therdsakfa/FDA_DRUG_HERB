<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_DI_STAFF_SELECT_COMPANY.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_DI_STAFF_SELECT_COMPANY" %>
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <table class="table" style="width:90%"> 
                     ...
                     <tr><td>
                         <asp:DropDownList ID="ddl_company" runat="server" AutoPostBack="True" Width="80%" DataTextField="" DataValueField="">
                         </asp:DropDownList>
                         </td></tr>
