<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_SUBSTITUTE_NCT_MAIN_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_SUBSTITUTE_NCT_MAIN_STAFF" %>
    ...
    <div class="h3" style="padding-left:5%;">  <asp:Label ID="lbl_name" runat="server" Visible="false" Text=""></asp:Label> </div>
     ...
     <div class="panel" style="text-align:left ;width:100%">
         <div class="panel-heading panel-title" style="height:70px" > 
             ...
             <div  class="col-lg-4 col-md-4"><h4> คำขอใบแทนใบอนุญาตสถานที่ด้านยา</h4> </div>
               ...
               <MasterTableView AutoGenerateColumns="False">
                   <Columns>
                       ...
                       <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_print" 
                           CommandName="print" Text="ใบอนุญาต">
                           <HeaderStyle Width="70px" />
                       </telerik:GridButtonColumn>
                   </Columns>
               </MasterTableView>
