<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_EDIT_TABEAN_YA_MAIN_EDIT_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_EDIT_TABEAN_YA_MAIN_EDIT_STAFF" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ContentPlaceHolder1_btn_upload').click(function () {
                ...
                //  $('#spinner').toggle('slow');
                Popups('POPUP_EDIT_TABEAN_YA_UPLOAD.aspx?IDA=' + IDA);
                return false;
            });
            ...
            //    var IDA = getQuerystring("IDA");
            //    //  $('#spinner').toggle('slow');
            //    Popups('POPUP_EDIT_TABEAN_YA_DOWNLOAD.aspx?IDA=' + IDA);
            //    return false;
            //});
     ...
     <asp:GridView ID="GV_data" DataKeyNames="IDA" runat="server" Width="100%" CssClass="table" CellPadding="4" ForeColor="#333333"
           ...
           <Columns>
              ...
              <%-- <asp:BoundField DataField="rcvdate" DataFormatString="{0:d}" HeaderText="วันที่ยื่นคำขอ" ItemStyle-Width="20%">
                  ...
                  <asp:BoundField DataField="EDIT_FROM" HeaderText="ขอแก้ไข" />
        
                  <asp:BoundField DataField="STATUS_ID" HeaderText="สถานะ" ItemStyle-Width="20%">
                   <ItemStyle Width="20%"></ItemStyle>
               </asp:BoundField>
