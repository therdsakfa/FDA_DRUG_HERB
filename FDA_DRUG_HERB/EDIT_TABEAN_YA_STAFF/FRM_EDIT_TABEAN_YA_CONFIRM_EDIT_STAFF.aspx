<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_EDIT_TABEAN_YA_CONFIRM_EDIT_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_EDIT_TABEAN_YA_CONFIRM_EDIT_STAFF" %>
            ...
            <td rowspan="2" style="width:70%; vertical-align:top;">
             ...
             <td style="padding-left:10%;height:50%;" class="auto-style1">
                 ...
                 <table class="table" style="width:90%">
                     <tr><td>
                         <asp:DropDownList ID="ddl_cnsdcd" runat="server" AutoPostBack="True" Width="80%">
                         </asp:DropDownList>
                         </td></tr>
