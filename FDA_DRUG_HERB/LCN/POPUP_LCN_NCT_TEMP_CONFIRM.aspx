<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_LCN_NCT_TEMP_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_LCN_NCT_TEMP_CONFIRM" %>
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <table class="table" style="width:90%"> 
                     ...
                     <tr><td><asp:Button ID="btn_confirm" runat="server" Text="อนุมัติ" CssClass="btn-lg"   Width="80%" OnClientClick="return confirm('คุณต้องการบันทึกข้อมูลหรือไม่');"  /></td></tr>
                     <tr><td> &nbsp;</td></tr>
                     <tr><td>  &nbsp;</td></tr>
                     <tr><td>  &nbsp;</td></tr>
