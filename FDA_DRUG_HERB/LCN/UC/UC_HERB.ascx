        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="auto-style15">ห้องเลขที่
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="lbl_lcn_email" runat="server"></asp:TextBox>
                    ...
                    <td>
                        ...
                        <asp:Label ID="lbl_da_opentime" runat="server" Text="" Style="display: none"><p style="color:red">*กรุณาระบุเวลาทำการ</p></asp:Label>
                    </td>
                </tr>
            </table>
            &ensp;&ensp;
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>ชั้นที่</td>
                    <td>
                        <asp:Label ID="lbl_BSN_FLOOR" runat="server" Text=""></asp:Label></td>
                </tr>
                <tr>
                    <td></td>
                    <td>ห้องเลขที่</td>
                ...
                <tr>
                    <td class="auto-style3"></td>
                    <td>&nbsp;ที่อยู่ที่สามารถติดต่อได้ &nbsp;<asp:CheckBox ID="cb_addr" runat="server" AutoPostBack="True" />
                        <label for="vehicle1"></label>
                    </td>
                    <td>(ใช้ที่อยู่เดียวกันกับที่อยู่ตามทะเบียนบ้าน)</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
