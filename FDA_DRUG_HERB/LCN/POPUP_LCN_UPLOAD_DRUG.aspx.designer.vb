...
Partial Public Class POPUP_LCN_UPLOAD_DRUG
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents UC_ATTACH_DRUG1 As Global.FDA_DRUG_HERB.UC_ATTACH_DRUG
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents UC_ATTACH_DRUG2 As Global.FDA_DRUG_HERB.UC_ATTACH_DRUG
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents UC_ATTACH_DRUG4 As Global.FDA_DRUG_HERB.UC_ATTACH_DRUG
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents UC_ATTACH_DRUG5 As Global.FDA_DRUG_HERB.UC_ATTACH_DRUG
End Class
