<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_LCN_LCT_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_LCT_CONFIRM" %>
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;vertical-align:top;">
                 ...
                 <table class="table" style="width:90% "> 
                     ...
                     <tr><td>
                         <asp:DropDownList ID="ddl_location_type2" runat="server" CssClass="form-control"   Style="display: none" >
