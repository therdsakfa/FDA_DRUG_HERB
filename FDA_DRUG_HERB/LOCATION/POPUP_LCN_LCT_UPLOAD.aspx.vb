...
Public Class POPUP_LCN_LCT_UPLOAD
    ...
    Private Sub runQuery()
        ...
        _Process_ID = 99 ' bao.GET_PROCESS_ID(_type, "00")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dao.GetDataby_LCTNPCD(_type, "00")
    ...
    Protected Sub btn_Upload_Click(sender As Object, e As EventArgs) Handles btn_Upload.Click
        ...
        If Upload_Attach(TR_ID) Then 'เช็คไฟล์แนบ
            ...
            If insrt_to_database(XML_TRADER, TR_ID) = True Then 'ทำการส่ง XML เข้าไปเพื่อทำการ Insert เข้า DATABASE และ ส่ง TR_ID เข้าไปเพื่อเชื่อมโยง
                alert("คุณได้รับรหัสดำเนินการ " & NAME_TRANCESTION("DA", _Process_ID, _YEAR, TR_ID))
            Else
    ...
    Private Function insrt_to_database(ByVal XML_FILE As String, ByVal TR_ID As String) As Boolean
        ...
        Dim dao_thmbl As New DAO_CPN.clsDBsysthmbl
        Dim dao_amphr As New DAO_CPN.clsDBsysamphr
        Dim dao_chngwt As New DAO_CPN.clsDBsyschngwt
        Try
            ...
            If IsNothing(p2.NCT_LCTADDRs.thmblcd) = True Then
                alert("กรุณากรอกตำบล")
            ElseIf IsNothing(p2.NCT_LCTADDRs.chngwtcd) = True Then
                alert("กรุณากรอกจังหวัด")
            ElseIf IsNothing(p2.NCT_LCTADDRs.amphrcd) = True Then
            ...
            Else
                ...
                dao.fields.XMLNAME = NAME_TRANCESTION("DRUG", _Process_ID, _YEAR, TR_ID)
                dao.fields.DOWN_ID = p2.DOWNLOAD_ID
                dao.fields.STATUS_ID = 1
                dao.fields.SYSTEM_NAME = "DRUG"
                dao.fields.LOCATION_TYPE_ID = 1
                ...
                For Each dao_NCT_LCT_BSN.fields In p2.LOCATION_BSNs
                    ...
                    dao_NCT_LCT_BSN.fields.BSN_ENGFULLNAME = dao_NCT_LCT_BSN.fields.BSN_ENGNAME & " " & dao_NCT_LCT_BSN.fields.BSN_ENGLASTNAME
                    dao_NCT_LCT_BSN.fields.BSN_THAIFULLNAME = dao_NCT_LCT_BSN.fields.BSN_THAINAME & " " & dao_NCT_LCT_BSN.fields.BSN_THAILASTNAME

                    dao_thmbl.GetData_by_chngwtcd_amphrcd_thmblcd(dao_NCT_LCT_BSN.fields.CHANGWAT_ID, dao_NCT_LCT_BSN.fields.AMPHR_ID, dao_NCT_LCT_BSN.fields.TUMBON_ID)
                    dao_amphr.GetData_by_chngwtcd_amphrcd(dao_NCT_LCT_BSN.fields.CHANGWAT_ID, dao_NCT_LCT_BSN.fields.AMPHR_ID)
                    dao_chngwt.GetData_by_chngwtcd(dao_NCT_LCT_BSN.fields.CHANGWAT_ID)


                    dao_NCT_LCT_BSN.fields.BSN_THMBL_NAME = dao_thmbl.fields.thathmblnm

                    dao_NCT_LCT_BSN.fields.BSN_THMBL_ENGNAME = dao_thmbl.fields.engthmblnm
                    dao_NCT_LCT_BSN.fields.BSN_AMPHR_NAME = dao_amphr.fields.thaamphrnm
                    dao_NCT_LCT_BSN.fields.BSN_AMPHR_ENGNAME = dao_amphr.fields.engamphrnm
                    dao_NCT_LCT_BSN.fields.BSN_CHWNGNAME = dao_chngwt.fields.thachngwtnm
                    dao_NCT_LCT_BSN.fields.BSN_CHWNG_ENGNAME = dao_chngwt.fields.engchngwtnm
                    dao_NCT_LCT_BSN.fields.CREATE_DATE = Date.Now()
