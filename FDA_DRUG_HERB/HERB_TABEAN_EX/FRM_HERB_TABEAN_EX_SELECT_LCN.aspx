<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_PPK.Master" CodeBehind="FRM_HERB_TABEAN_EX_SELECT_LCN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_EX_SELECT_LCN" %>
    ...
    <div class="row" id="T1" runat="server" visible="false" style="padding-left: 1em;">
        <div class="panel" style="text-align: left; width: 100%">
            <div class="panel-heading panel-title" style="height: 70px">
                <p class="h3" style="text-align: left;">ระบบขอผลิตภัณฑ์ตัวอย่าง</p>
            </div>
        </div>
