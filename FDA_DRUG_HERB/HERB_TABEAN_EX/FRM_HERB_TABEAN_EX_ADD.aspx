<%@ Page Title="" Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPage/Main_Product.Master" CodeBehind="FRM_HERB_TABEAN_EX_ADD.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_EX_ADD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <asp:TextBox ID="style_color" TextMode="MultiLine" Width="80%" Height="50px" runat="server"></asp:TextBox>
    ...
    <div class="row">
        ...
        <div class="col-lg-9" style="border-bottom: #999999 1px dotted">
             ...
             <%--<asp:TextBox ID="txt_unit" runat="server" ReadOnly="True" Width="58px" BorderStyle="None"></asp:TextBox>--%>
            <%--<asp:DropDownList ID="ddl_package_unit" runat="server" AutoPostBack="True">
            </asp:DropDownList>        
           
            <asp:TextBox ID="txt_sum_unit" runat="server" ReadOnly="True" Width="134px" BorderStyle="None"></asp:TextBox>
            <asp:Button ID="btn_add" runat="server" Text="เพิ่ม" Height="27px" Width="76px" />--%>
        </div>
    </div>
     <div class="row">
    ...
    <div class="row">
        <div class="col-lg-12" style="text-align: center">
            <asp:Button ID="btn_save"  CausesValidation="true" ValidationGroup="valGroup1" runat="server" Text="บันทึกส่วนที่ 1" />
