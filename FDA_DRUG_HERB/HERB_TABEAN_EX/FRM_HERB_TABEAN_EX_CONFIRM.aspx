<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_EX_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_EX_CONFIRM" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            <div class="row" style="text-align: center">
                ...
                <div class="col-lg-10">
                    <asp:Button ID="btn_confirm" runat="server" Text="ยื่นคำขอ" CausesValidation="true" ValidationGroup="valGroup1" CssClass="btn-lg" Width="80%" OnClientClick="return confirm('คุณต้องการยื่นคำขอหรือไม่');" Height="60px" />
