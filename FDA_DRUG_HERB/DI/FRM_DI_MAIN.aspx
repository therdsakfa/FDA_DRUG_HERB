<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCT_PHESAJ.Master" CodeBehind="FRM_DI_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DI_MAIN" %>
    ...
    <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2> ลงทะเบียน GMP สถานที่ผลิต&nbsp;
                <asp:Label ID="lbl_lcnno_Name" runat="server"></asp:Label>
            </h2>
