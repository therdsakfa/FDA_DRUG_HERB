...
Public Class FRM_SELECT_PROCESS_LCN_MAIN
    ...
    Public Sub BindMenu(ByVal NodeGroup As Integer)
        ...
        For Each dao.fields In dao.datas
            ...
            If (dao.fields.PROCESS_ID = "130001" Or dao.fields.PROCESS_ID = "130002") AndAlso
           Not (dao_dal.fields.lcntpcd.Contains("บ") Or dao_dal.fields.lcntpcd.Contains("สม")) Then
                TreeView1.Nodes.Add(t_node)
            ElseIf (dao.fields.PROCESS_ID = "130003" Or dao.fields.PROCESS_ID = "130004") AndAlso
               (dao_dal.fields.lcntpcd.Contains("บ") Or dao_dal.fields.lcntpcd.Contains("สม")) Then
                TreeView1.Nodes.Add(t_node)
            ElseIf Not (dao.fields.PROCESS_ID = "130003" Or dao.fields.PROCESS_ID = "130004" Or dao.fields.PROCESS_ID = "130001" Or dao.fields.PROCESS_ID = "130002") Then
                TreeView1.Nodes.Add(t_node)
            End If
            If ACTVIE = False Then
                t_node.Enabled = False
                t_node.CssClass = "disabledNode"
            End If
            gen_child_node(t_node.Nodes, dao.fields.IDA, NodeGroup)
            'End If
        Next
