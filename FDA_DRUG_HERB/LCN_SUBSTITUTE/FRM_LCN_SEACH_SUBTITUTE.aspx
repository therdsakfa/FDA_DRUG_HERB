<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_LCN_SEACH_SUBTITUTE.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_SEACH_SUBTITUTE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <img src="../imgs/spinner.gif" alt="Loading" style="position: absolute; top: 120px; left: 293px; height: 185px; width: 207px;" />
     ...
     <div class="panel" style="text-align:left ;width:100%">
         <div  style="height:70px" > 
            <div class="row">
                ...
                <div class="col-lg-2"> โปรดเลือกเลขใบอนุญาต</div>
                <div class="col-lg-3">
    ...
    <Columns>
        <asp:BoundField DataField="LCNNO_DISPLAY" HeaderText="เลขที่ใบอนุญาต" ItemStyle-Width ="20%" ItemStyle-HorizontalAlign="Left" />
        <asp:BoundField DataField="thanameplace" HeaderText="ชื่อสถานที่" ItemStyle-Width ="25%" ItemStyle-HorizontalAlign="Left" />        
        <asp:BoundField DataField="fulladdr" HeaderText="ที่อยู่" ItemStyle-Width ="55%" /> 
