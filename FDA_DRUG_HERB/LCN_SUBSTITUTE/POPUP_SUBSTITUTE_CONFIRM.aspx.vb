...
Public Class POPUP_SUBSTITUTE_CONFIRM
    ...
    Private Sub BindData_PDF()
        ...
        Try
            ...
            'bsn_name_full = ws_taxno.SYSLCNSNMs.prefixnm & " " & ws_taxno.SYSLCNSNMs.thanm & " " & ws_taxno.SYSLCNSNMs.thalnm
            bsn_name = dao_bsn.fields.BSN_THAIFULLNAME
            bsn_name_full = dao_bsn.fields.BSN_THAIFULLNAME
        Catch ex As Exception
        ...
        Cls_XML.FULL_BSN_NAME = bsn_name_full
