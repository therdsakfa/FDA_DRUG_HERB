<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_SUBSTITUTE_CONFIRM_DETAIL.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_SUBSTITUTE_CONFIRM_DETAIL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel" style="width: 100%">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <asp:TextBox ID="TextBox1" runat="server" TextMode="MultiLine" Height="60px" Width="100%"></asp:TextBox>
            </div>
            <div class="col-lg-1"></div>
        </div>
        <br />
        ...
        <div class="panel-footer " style="text-align: center;">
            ...
            <asp:Button ID="Button2" runat="server" Text="ย้อนกลับ" CssClass="btn-lg" />
            &nbsp;&nbsp;
