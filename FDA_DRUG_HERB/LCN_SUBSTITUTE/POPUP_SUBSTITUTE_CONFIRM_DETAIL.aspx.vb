...
Public Class POPUP_SUBSTITUTE_CONFIRM_DETAIL
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            RQ_NUM = GEN_NO_INTAKE(con_year(Date.Now.Year), dao.fields.PROCESS_ID, _IDA_LCN)
            Dim RQ_YEAR As String = con_year(Date.Now().Year()).Substring(2, 2)
            dao.fields.rcvno_new = "HB " & pvncd & "-" & _PROCESS_ID.ToString & "-" & RQ_YEAR & "-" & RQ_NUM.ToString
