...
Public Class FRM_LCN_SUBTITUTE_UPLOAD
    ...
    Protected Sub btn_Upload_Click(sender As Object, e As EventArgs) Handles btn_Upload.Click
        ...
        Dim bao As New BAO.AppSettings
            ...
            End Try
        'End If
        Response.Redirect("FRM_LCN_SUBSTITUTE_MAIN.aspx?process=" & _ProcessID & "&lct_ida=" & _lct_ida & "&identify=" & _iden & "&lcn_ida=" & _IDA)
    End Sub

    Sub alert(ByVal text As String)
        Response.Write("<script type='text/javascript'>window.parent.alert('" + text + "');</script> ")
        'System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "../LCN_SUBSTITUTE/POPUP_SUBSTITUTE_CONFIRM.aspx?IDA=" & _lcn_ida & "');", True)
    End Sub
    Private Function insrt_to_database(ByVal FileName As String, ByVal TR_ID As Integer) As Boolean
        ...
        Try
            ...
            Dim p2 As New CLASS_DALCN_SUBSTITUTE
            ...
            dao.fields = p2.DALCN_SUBSTITUTEs
            ...
            'dao.fields.Citi = _CLS.CITIZEN_ID
