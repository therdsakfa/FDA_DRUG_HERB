<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" MaintainScrollPositionOnPostback="true" CodeBehind="FRM_LCN_EDIT_STAFF_INTAKE.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_EDIT_STAFF_INTAKE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            showdate($("#ContentPlaceHolder1_TXT_RQ_DATE"));
        });
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <asp:DropDownList ID="DD_STATUS" runat="server" DataValueField="STATUS_ID" DataTextField="STATUS_NAME_STAFF" Style="width: 100%" AutoPostBack="true"></asp:DropDownList>
                </div>
                <div class="col-lg-1"></div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6" runat="server">
                    <asp:TextBox ID="TXT_RQ_DATE" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
                ...
                <div class="col-lg-4">
                    <asp:DropDownList ID="DDL_RQ_STAFF" runat="server" DataValueField="IDA" DataTextField="STAFF_NAME" Width="200px" AutoPostBack="true"></asp:DropDownList>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12" style="text-align: center">
                    <h3>เอกสารแนบคำข้อแก้ไขใบอนุญาต</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
