...
Public Class FRM_LCN_EDIT_STAFF_INTAKE
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            bind_pdf_xml_3(_IDA, _LCN_IDA, _ProcessID, _STATUS_ID, dao.fields.DATE_YEAR, dao.fields.TR_ID)
    ...
    Public Sub Run_PDF_SMP3()
        ...
        dao_pdftemplate.GETDATA_LCN_EDIT_TEMPLAETE(_ProcessID, dao.fields.STATUS_ID, "สมพ3", 1)
    ...
    Public Sub bind_mas_staff()
        ...
        DDL_RQ_STAFF.DataSource = dt
        DDL_RQ_STAFF.DataBind()
        DDL_RQ_STAFF.Items.Insert(0, "-- กรุณาเลือก --")
    End Sub
    ...
    End Sub
    Public Function insert_transection_lcn_edit(ByVal PROCESS_ID As Integer, ByVal LCN_IDA As Integer) As Integer

        Dim dao_up As New DAO_LCN.TB_LCN_APPROVE_EDIT_TRANSACTION_RQ_NUMBER
        ...
        dao_up.fields.FK_IDA_LCN = LCN_IDA
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_sumit.Click
        ...
        Else
            ...
            Try
                dao.fields.STAFF_RQ_DATE = DateTime.ParseExact(TXT_RQ_DATE.Text, "dd/MM/yyyy", New CultureInfo("th-TH").DateTimeFormat)
            Catch ex As Exception
                dao.fields.STAFF_RQ_DATE = System.DateTime.Now
            End Try
            ...
            bind_pdf_xml_3(ida_xml, _LCN_IDA, process_xml, dao.fields.STATUS_ID, year_xml, tr_id_xml)

            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('บันทึกเรียบร้อย');parent.close_modal();", True)
        End If
    End Sub

    Public Sub bind_pdf_xml_3(ByVal _IDA As Integer, ByVal _LCN_IDA As Integer, ByVal _ProcessID As Integer, ByVal _StatusID As Integer, ByVal _YEAR As String, ByVal _tr_id_xml As String)
        Dim XML As New CLASS_GEN_XML.LCN_EDIT_SMP3
        TB_SMP3 = XML.gen_xml(_IDA, _LCN_IDA, _YEAR)
    ...
    Protected Sub DD_STATUS_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DD_STATUS.SelectedIndexChanged
        ...
        End If
        'If DD_STATUS.SelectedValue = 12 Then
        '    P12.Visible = True
        'ElseIf DD_STATUS.SelectedValue = 0 Then
        '    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('กรุณาเลือกรายการ');", True)
        'Else
        '    P12.Visible = False
        'End If
