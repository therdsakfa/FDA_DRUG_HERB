<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" MaintainScrollPositionOnPostback="true" CodeBehind="FRM_LCN_EDIT_STAFF_APPROVE.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_EDIT_STAFF_APPROVE" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <asp:TextBox ID="TXT_APPROVE_NOTE" runat="server" TextMode="MultiLine" Width="200px" Height="50px"></asp:TextBox>
                </div>
            </div>
