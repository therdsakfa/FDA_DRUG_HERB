<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" MaintainScrollPositionOnPostback="true" CodeBehind="FRM_LCN_EDIT_STAFF_SIGN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_EDIT_STAFF_SIGN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            showdate($("#ContentPlaceHolder1_TXT_SIGN_DATE"));
        });
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <asp:DropDownList ID="DD_STATUS" runat="server" DataValueField="STATUS_ID" DataTextField="STATUS_NAME_STAFF" Width="250px" AutoPostBack="true"></asp:DropDownList>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
                ...
                <div class="col-lg-4">
                    <asp:TextBox ID="TXT_RQ_NUMBER" runat="server" ReadOnly="true"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
                ...
                <div class="col-lg-6">
                    <asp:TextBox ID="TXT_SIGN_DATE" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
                ...
                <div class="col-lg-4">
                    <asp:DropDownList ID="DDL_SIGN_STAFF" runat="server" DataValueField="IDA" DataTextField="STAFF_NAME" Width="250px" AutoPostBack="true"></asp:DropDownList>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
                ...
                <div class="col-lg-4">
                    <asp:TextBox ID="TXT_SIGN_NOTE" runat="server" TextMode="MultiLine" Width="200px" Height="50px"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
