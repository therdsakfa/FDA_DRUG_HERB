...
Public Class FRM_CHEMICAL_STAFF_COMFIRM_TEXT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            UC_GRID_ATTACH1.load_gv_V2(_IDA, dao.fields.PROCESS_ID)
            Try
            ...
            End Try
            Try
                lbl_aori.Text = dao.fields.aori
            Catch ex As Exception

            End Try
            Try
                lbl_casno.Text = dao.fields.cas_number
            Catch ex As Exception
            ...
            End Try
            Try
                txt_Cas_number.Text = dao.fields.cas_number
            Catch ex As Exception

            End Try
            Try
                lbl_mobile.Text = dao.fields.TEL
            Catch ex As Exception
    ...
    Protected Sub btn_confirm_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        If ddl_aori.SelectedItem.Text = "กรุณาเลือก" Or ddl_aori.SelectedItem.Text = "" Then
            alert_only("กรุณาเลือกชนิดสาร A or I")
        Else
            ...
            If statusID = "7" Then
                Response.Redirect("FRM_CHEMICAL_STAFF_REMARK.aspx?IDA=" & _IDA & "&TR_ID=" & _TR_ID)
            ...
            ElseIf statusID = "8" Then
                ...
                If ddl_Modern_drug.SelectedValue = "T" Then
                    Insert_driowa(_IDA)
                End If
    ...
    Public Sub insert_to_mas_chemical(ByVal ida As Integer)
        ...
        dao_cm.fields.INN_TH = dao.fields.INN_TH
        dao_cm.insert()
    End Sub
    Sub Insert_driowa(ByVal ida As Integer)
        Dim dao As New DAO_DRUG.TB_CHEMICAL_REQUEST
        dao.GetDataby_IDA(ida)

        Dim dao_cm As New DAO_DRUG.TB_driowa
        dao_cm.fields.iowa = dao.fields.iowacd
        dao_cm.fields.run = dao.fields.runno
        dao_cm.fields.salt = dao.fields.salt
        dao_cm.fields.syn = dao.fields.syn
