<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" MaintainScrollPositionOnPostback="true" CodeBehind="FRM_HERB_TABEAN_STAFF_JJ.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_STAFF_JJ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="text-align: center">
        <h3>รายการข้อมูลยื่นคำขอจดแจ้ง</h3>
    </div>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="true" PageSize="25" AllowFilteringByColumn="True" Width ="100%">
                <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="DATE_REQ" DataType="System.DateTime" FilterControlAltText="Filter DATE_REQ column"
                            HeaderText="วันที่รับคำขอ" SortExpression="DATE_REQ" UniqueName="DATE_REQ" DataFormatString="{0:dd/MM/yyyy}">
                        </telerik:GridBoundColumn>
