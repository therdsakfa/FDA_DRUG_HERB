<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_STAFF_JJ_APPROVE.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_STAFF_JJ_APPROVE" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <asp:DropDownList ID="DDL_JJ2_SELECT" runat="server" BackColor="White" Height="25px" Width="200px" SkinID="bootstrap" AutoPostBack="true">
            ...
            <div class="row" style="text-align: center">
                <div class="col-lg-1"></div>
                <div class="col-lg-10">
                    <asp:Button ID="btn_download_jj1" runat="server" Text="Preview จจ.1" CssClass="btn-lg" Width="80%" />
                </div>
                <div class="col-lg-1"></div>
            </div>
            <hr />
            <div class="row">
                <div class="col-lg-12" style="text-align: center">
                    <h3>อัพโหลดเอกสาร จจ.2 ที่อนุมัติแล้ว</h3>
                </div>
            </div>
            ...
            <div class="row" runat="server" id="uc_upload1_btn" visible="true">
                <div class="col-lg-12" style="text-align: center">
                    <asp:Button ID="btn_savefileapprove_jj2" runat="server" Text="บันทึกแบบไฟล์" CssClass="btn-lg" Width="80%" />
                </div>
            </div>
