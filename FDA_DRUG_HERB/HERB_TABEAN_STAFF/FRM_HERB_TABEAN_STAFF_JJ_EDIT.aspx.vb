...
Public Class FRM_HERB_TABEAN_STAFF_JJ_EDIT
    ...
    Public Sub bind_data()
        ...
        'For Each dao_up_mas.fields In dao_up_mas.datas
        '    Dim dao_chks As New DAO_TABEAN_HERB.TB_TABEAN_HERB_UPLOAD_FILE_JJ
        '    dao_chks.Getdataby_DUCUMENT_NAME_AND_FK_IDA_AND_PROCESS(dao_up_mas.fields.DUCUMENT_NAME, _IDA, _ProcessID)
        '    If dao_chks.fields.IDA = 0 Then
        '        Dim dao_up As New DAO_TABEAN_HERB.TB_TABEAN_HERB_UPLOAD_FILE_JJ
        '        dao_up.fields.DUCUMENT_NAME = dao_up_mas.fields.DUCUMENT_NAME
        '        dao_up.fields.TR_ID = _TR_ID
        '        dao_up.fields.FK_IDA = _IDA
    ...
    Public Sub Run_Pdf_Tabean_Herb()
        ...
        lr_preview.Text = "<iframe id='iframe1'  style='height:600px;width:100%;border-radius:5px;' src='../PDF/FRM_PDF.aspx?fileName=" & PATH_PDF_OUTPUT & "' ></iframe>"
    ...
    Function bind_data_uploadfile_4()
        ...
        Type_ID = dao_up.fields.TYPE
        dt = bao.SP_TABEAN_HERB_UPLOAD_FILE_JJ_FK_IDA_LCN_STAFF(_TR_ID, 3, _ProcessID, dao.fields.IDA_LCN)
        Return dt
    End Function
