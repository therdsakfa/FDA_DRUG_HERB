...
Public Class POPUP_DP_CONFIRM
    ...
    Private Sub BindData_PDF()
        ...
        Dim cls_regis As New CLASS_GEN_XML.DP(_CLS.CITIZEN_ID, dao.fields.lcnsid, dao.fields.lcnno, dao.fields.lcntpcd, dao.fields.pvncd, dao.fields.FK_IDA)
