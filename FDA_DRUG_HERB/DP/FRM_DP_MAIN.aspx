<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NODE.Master" CodeBehind="FRM_DP_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DP_MAIN" %>
     ...
     <script type="text/javascript" >
         $(document).ready(function () {
             ...
             $('#ContentPlaceHolder1_btn_upload').click(function () {
                 ...
                 //  $('#spinner').toggle('slow');
                 Popups('POPUP_DP_UPLOAD.aspx?fk_ida=' + IDA);
                 return false;
             });
  ...
  <asp:GridView ID="GV_data" DataKeyNames="IDA" runat="server" Width="100%" CssClass="table" CellPadding="4" ForeColor="#333333"
   ...
   <div class=" modal fade" id="myModal">              
               <div class="panel panel-info" style="width:100%;">
                   <div class="panel-heading  text-center"><h1>รายละเอียด Placebo </h1></div>
