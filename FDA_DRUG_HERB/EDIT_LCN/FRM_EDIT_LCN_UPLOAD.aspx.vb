...
Imports System.Xml
Public Class FRM_EDIT_LCN_UPLOAD
    ...
    Private Function insrt_to_database(ByVal FileName As String, ByVal TR_ID As String) As Boolean
        ...
        dao.fields = p2.DALCN_EDIT_REQUESTs

        dao.fields.PROCESS_ID = _ProcessID
        dao.fields.CITIZEN_ID_AUTHORIZE = _CLS.CITIZEN_ID_AUTHORIZE
        Try
            dao.fields.WRITE_AT = p2.DALCN_EDIT_REQUESTs.WRITE_AT
        Catch ex As Exception

        End Try
        Try
            dao.fields.WTIRE_DATE = p2.DALCN_EDIT_REQUESTs.WTIRE_DATE
        Catch ex As Exception
