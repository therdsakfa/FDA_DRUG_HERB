<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_EDIT_LCN_CONFIRM_DRUG.aspx.vb" Inherits="FDA_DRUG_HERB.WebForm10" %>

<%@ Register Src="~/UC/UC_GRID_ATTACH.ascx" TagPrefix="uc1" TagName="UC_GRID_ATTACH" %>
<%@ Register Src="~/UC/UC_GRID_PHARMACIST.ascx" TagPrefix="uc1" TagName="UC_GRID_PHARMACIST" %>
    ...
    <table style="width:100%;height:500px;">
        ...
        <tr>
             <td style="width:30%;height:50%;padding-left:10%">
                 ...
                 <br />
                 <uc1:UC_GRID_PHARMACIST runat="server" ID="UC_GRID_PHARMACIST" />
