<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_EDIT_LCN_DRUG.aspx.vb" Inherits="FDA_DRUG_HERB.WebForm9" %>
    ...
    <div class="h3" style="padding-left:5%;">  <asp:Label ID="lbl_name" runat="server" Visible="false" Text=""></asp:Label> </div>
     ...
     <div class="panel" style="text-align:left ;width:100%">
       ...
       <div class="panel panel-body"  style="width:100%;padding-left:5%;">
           <asp:GridView  ID="GV_lcnno"  runat="server" Width="90%"  DataKeyNames="IDA" CellPadding="4" CssClass="table" 
