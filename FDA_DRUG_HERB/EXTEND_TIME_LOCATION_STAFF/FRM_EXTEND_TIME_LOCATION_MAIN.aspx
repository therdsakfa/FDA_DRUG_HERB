<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_EXTEND_TIME_LOCATION_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_EXTEND_TIME_LOCATION_MAIN" %>
   ...
   <div>
       <table width="100%">
           <tr>
            ...
            <tr>
                <td>ประเภทใบอนุญาต(ค่าจ่ายตามม.44)</td>
                <td Width="70%">
            ...
            <tr>
                ...
                <td Width="70%">
                               <%--<asp:DropDownList ID="ddl_search2" runat="server" CssClass="btn-lg" Width="70%"></asp:DropDownList>--%>
                                <asp:Label ID="lbl_price" runat="server" Text="-" CssClass="btn-lg"></asp:Label> &nbsp; บาท
                                <%--<asp:TextBox ID="txt_price" runat="server" CssClass="btn-lg" Width="70%"></asp:TextBox>--%>
                </td>
            </tr>
            <tr>
                <td>จำนวนเงินตามม.44</td>
                <td Width="70%">
                               <asp:Label ID="lbl_price44" runat="server" Text="-" CssClass="btn-lg" ></asp:Label>&nbsp; บาท</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td Width="70%">
                               <asp:Label ID="lbl_price44_2" runat="server" Text="2,000" CssClass="btn-lg" style="display:none;"></asp:Label>&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td Width="70%">
