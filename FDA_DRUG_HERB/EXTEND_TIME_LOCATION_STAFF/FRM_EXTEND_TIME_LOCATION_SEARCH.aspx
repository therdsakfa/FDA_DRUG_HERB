<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_EXTEND_TIME_LOCATION_SEARCH.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_EXTEND_TIME_LOCATION_SEARCH1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2>ค้นหาใบอนุญาตต่ออายุสถานที่ด้านยา</h2>
...
<MasterTableView autogeneratecolumns="False" datakeynames="Newcode_not" NoMasterRecordsText="ไม่พบข้อมูล">

    <Columns>
       
        <telerik:GridBoundColumn DataField="Newcode_not" FilterControlAltText="Filter Newcode_not column"
        ...
        <telerik:GridBoundColumn DataField="type_table"  FilterControlAltText="Filter type_table column"
             HeaderText="type_table" ReadOnly="True" SortExpression="type_table" UniqueName="type_table" Display="false">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="CITIZEN_AUTHORIZE"  FilterControlAltText="Filter CITIZEN_AUTHORIZE column"
             HeaderText="CITIZEN_AUTHORIZE" ReadOnly="True" SortExpression="CITIZEN_AUTHORIZE" UniqueName="CITIZEN_AUTHORIZE" Display="false">
        </telerik:GridBoundColumn>
     ...
     <%--   <telerik:GridBoundColumn DataField="REQUEST_DATE" FilterControlAltText="Filter REQUEST_DATE column" DataType="System.DateTime" 
       ...
       <telerik:GridBoundColumn DataField="thanm" FilterControlAltText="Filter thanm column" 
        ...
        <telerik:GridBoundColumn DataField="grannm_lo" FilterControlAltText="Filter grannm_lo column" 
            ...
            <telerik:GridBoundColumn DataField="expyear" FilterControlAltText="Filter expyear column" 
            HeaderText="ปีที่หมดอายุ" SortExpression="expyear" UniqueName="expyear" >
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="status_pay" FilterControlAltText="Filter status_pay column" 
            HeaderText="สถานะการชำระเงิน" SortExpression="status_pay" UniqueName="status_pay" >
        </telerik:GridBoundColumn>
           ...
           <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_print"
             ...
             <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_Select"
                       CommandName="save" Text="ปรับสถานะการชำระเงิน">
                       <HeaderStyle Width="70px" />
                   </telerik:GridButtonColumn>
    </Columns>
    </MasterTableView>
