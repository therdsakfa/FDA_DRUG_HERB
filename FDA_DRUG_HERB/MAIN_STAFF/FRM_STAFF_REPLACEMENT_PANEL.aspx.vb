Public Class FRM_STAFF_REPLACEMENT_PANEL
    ...
    Private Sub btn_dh_Click(sender As Object, e As EventArgs) Handles btn_dh.Click
        Dim url As String = ""
        url = "https://meshlog.fda.moph.go.th/AdvertiseDrugHerbs?TOKEN=" & _CLS.TOKEN
        ' url = "https://meshlog.fda.moph.go.th/AdvertiseDrugHerbs/Home_Admin/Index_Admin?TOKEN=" & _CLS.TOKEN
