<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_REPLACEMENT_LICENSE_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_REPLACEMENT_LICENSE_MAIN" %>
                ...
                <telerik:RadGrid ID="rg_name" runat="server" AllowPaging="true" PageSize="15">
                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="ID">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn>
                                <ItemTemplate>
                                    <asp:Button ID="HL_SELECT2" runat="server" Text="เลือกข้อมูล(สถานที่จำลอง)" CommandName="sel2" />
                                    <%--<asp:HyperLink ID="HL_SELECT"  runat="server">เลือกข้อมูล</asp:HyperLink>--%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                        </Columns>
