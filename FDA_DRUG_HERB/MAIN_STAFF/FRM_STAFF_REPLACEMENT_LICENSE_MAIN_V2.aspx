<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_REPLACEMENT_LICENSE_MAIN_V2.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_REPLACEMENT_LICENSE_MAIN_V2" %>
    ...
    <div class="panel" style="text-align: left; width: 100%">
        <div class="panel-heading panel-title" style="height: 70px">
            <div class="col-lg-4 col-md-4">
                <h4>ใบรับเรื่องแทนผู้ประกอบการ</h4>
            </div>
                    ...
                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="ID">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn>
                                <ItemTemplate>
                                    <asp:Button ID="HL_SELECT" runat="server" Text="เลือกสถานที่ผลิตของตน" CommandName="sel" />
                                    <%--<asp:HyperLink ID="HL_SELECT"  runat="server">เลือกข้อมูล</asp:HyperLink>--%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn>
                                <ItemTemplate>
                                    <asp:Button ID="HL_SELECT2" runat="server" Text="เลือกสถานที่ผลิตอื่น" CommandName="sel2" />
                                    <%--<asp:HyperLink ID="HL_SELECT"  runat="server">เลือกข้อมูล</asp:HyperLink>--%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                        </Columns>
