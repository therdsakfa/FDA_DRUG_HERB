...
Public Class UC_TABEAN_JJ_EQTO
    ...
    Protected Sub btn_select_Click(sender As Object, e As EventArgs) Handles btn_select.Click
        ...
        If ddl_unit.SelectedValue <> 0 And txt_QTY.Text <> "" Then
            ...
            For Each item As GridDataItem In rg_search_iowa.SelectedItems
                ...
                'Dim dao As New DAO_TABEAN_HERB.TB_TABEAN_JJ_EQTO
                Dim dao As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_EQTO
                ...
                'Dim dao_max As New DAO_TABEAN_HERB.TB_TABEAN_JJ_EQTO
                Dim dao_max As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_EQTO
                'dao_max.GET_MAX_ROWS_ID_SET(_IDA, Request.QueryString("fk_set"))
                dao_max.GET_MAX_ROWS_ID_SET(_HERB_ID, Request.QueryString("fk_set"))
    ...
    Private Sub rg_chem_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles rg_chem.NeedDataSource
        ...
        'dt = bao.SP_TABEAN_JJ_EQTO_BY_FK_IDA(_IDA)
        dt = bao.SP_MAS_TABEAN_JJ_EQTO_BY_FK_IDA(_IDA)
