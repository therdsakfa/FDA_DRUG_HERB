...
Public Class UC_TABEAN_JJ_DETAIL_CAS
    ...
    Sub RunQuery()
        ...
        Try
            ...
            Else
                STATUS_ID = Get_TabeanJJ_Status_by_trid(Request.QueryString("tr_id"))
            End If
        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "_del" Then
                ...
                Else
                    ...
                    Dim dao As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_DETAIL_CAS
                    dao.GetDataby_IDA(IDA)
                        FK_SET = dao.fields.FK_SET
                        dao.delete()

                    'dao = New DAO_TABEAN_HERB.TB_TABEAN_JJ_DETAIL_CAS
                    dao = New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_DETAIL_CAS
                    dao.GetDataby_FK_IDA_ORDER(_IDA, FK_SET)
                        Dim i As Integer = 1
                        For Each dao.fields In dao.datas
                        'Dim dao_up As New DAO_TABEAN_HERB.TB_TABEAN_JJ_DETAIL_CAS
                        Dim dao_up As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_DETAIL_CAS
            ...
            ElseIf e.CommandName = "_eqto" Then
                Dim url As String = "../TABEAN_YA/FRM_EQTO.aspx?IDA=" & IDA & "&type=" & Request.QueryString("type") & "&tr_id=" & Request.QueryString("tr_id") & "&idr=" & _IDA & "&STATUS_ID=" & STATUS_ID & "&fk_set=" & item("FK_SET").Text & "&HERB_ID=" & _HERB_ID
    ...
    Private Sub rg_chem_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles rg_chem.NeedDataSource
        ...
        'dt = bao.SP_TABEAN_JJ_DETAIL_CAS_BY_FK_IDA(_IDA, ddl_set.SelectedValue)
        dt = bao.SP_MAS_TABEAN_JJ_DETAIL_CAS_BY_FK_IDA(_IDA, ddl_set.SelectedValue)
    ...
    Protected Sub btn_select_Click(sender As Object, e As EventArgs) Handles btn_select.Click
        ...
        For Each item As GridDataItem In rg_search_iowa.SelectedItems
            ...
            Dim dao_max As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_DETAIL_CAS
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        'Dim dao_count As New DAO_TABEAN_HERB.TB_TABEAN_JJ_EACH
        Dim dao_count As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_EACH
        Dim i As Integer = 0
            i = dao_count.CountDataby_FK_IDA(Request.QueryString("IDA"))
        If i = 0 Then
            'Dim dao As New DAO_TABEAN_HERB.TB_TABEAN_JJ_EACH
            Dim dao As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_EACH
    ...
    Private Sub btn_up_Click(sender As Object, e As EventArgs) Handles btn_up.Click
        ...
        For Each item As GridDataItem In rg_chem.SelectedItems
            Dim dao_curr As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_DETAIL_CAS
            Dim dao_max As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_DETAIL_CAS
            Dim dao_min As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_DETAIL_CAS
            Dim dao_rowup As New DAO_TABEAN_HERB.TB_MAS_TABEAN_JJ_DETAIL_CAS
