<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_JJ_PREVIEW_JJ2.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_JJ_PREVIEW_JJ2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <%--<div class="col-lg-3" style="width: 100%; text-align: center">
            <hr />
            <div class="row">
