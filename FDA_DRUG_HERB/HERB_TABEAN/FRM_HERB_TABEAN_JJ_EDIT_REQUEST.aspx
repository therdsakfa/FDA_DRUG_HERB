<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_JJ_EDIT_REQUEST.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_JJ_EDIT_REQUEST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
     ...
     <div class="row" id="data_show3" runat="server" visible="false">
        ...
        <div class="col-lg-3" style="border-bottom: #999999 1px dotted; text-align: center">
            <asp:TextBox ID="txt_agent99" runat="server" Width="100%"></asp:TextBox>
        </div>
        <div class="col-lg-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <asp:DropDownList ID="DD_TYPE_SUB_ID" runat="server" BackColor="White" Height="25px" Width="100%" SkinID="bootstrap" Enabled="true">
                ...
                <asp:ListItem Value="4">ยาจากสมุนไพร (ยาแผนไทย)</asp:ListItem>
    ...
    <div class="row">
        ...
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="ACCOUNT_NO" runat="server" BorderStyle="None" ReadOnly="true"  Width="100%"></asp:TextBox>
        </div>
        <div class="col-lg-1" style="text-align: right;">
            <label>ข้อ:</label>
        </div>
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="ARTICLE_NO" runat="server" BorderStyle="None" ReadOnly="true"  Width="100%"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
