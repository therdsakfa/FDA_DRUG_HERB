...
Public Class FRM_HERB_TABEAN_NEW_WHO
    ...
    Function bind_data()
        ...
        dt = bao.SP_WHO_CUSTOMER_LCN_BY_IDENTIFY(CID)
        Return dt
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            If hdf_select.Value = 1 Then
                H.NavigateUrl = "../HERB_TABEAN_NEW/FRM_HERB_TABEAN.aspx?TR_ID_LCN=" & TR_ID_LCN & "&MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & IDA_LCN & "&PROCESS_ID_LCN=" & PROCESS_ID & "&SID=2" 'URL หน้า ยืนยัน
            ElseIf hdf_select.Value = 2 Then

            ElseIf hdf_select.Value = 3 Then
                H.NavigateUrl = "FRM_HERB_TABEAN_JJ.aspx?IDA_LCT=" & FK_IDA_LCT & "&TR_ID_LCN=" & TR_ID_LCN & "&MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & IDA_LCN & "&PROCESS_ID_LCN=" & PROCESS_ID & "&SID=2" 'URL หน้า ยืนยัน
            ElseIf hdf_select.Value = 4 Then
                H.NavigateUrl = "../HERB_TABEAN_EX/FRM_HERB_TABEAN_EX.aspx?IDA_LCT=" & FK_IDA_LCT & "&TR_ID_LCN=" & TR_ID_LCN & "&MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & WHO_IDA & "&PROCESS_ID_LCN=" & PROCESS_ID & "&SID=2" 'URL หน้า ยืนยัน
