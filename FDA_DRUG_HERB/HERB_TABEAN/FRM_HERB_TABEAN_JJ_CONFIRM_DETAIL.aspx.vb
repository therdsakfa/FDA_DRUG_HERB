...
Public Class FRM_HERB_TABEAN_JJ_CONFIRM_DETAIL
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim RCVNO_FULL As String = "HB" & " " & "10" & "-" & _ProcessID & "-" & DATE_YEAR & "-" & TR_ID_JJ
            ...
            'SW.INSERT_HERB_PAYMENT_CENTER_L44(dao.fields.CITIZEN_ID_AUTHORIZE, _IDA, dao.fields.DDHERB)
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Response.Redirect("FRM_HERB_TABEAN_CONFIRM.aspx?IDA=" & _IDA & "&TR_ID=" & _TR_ID & "&SID=" & Request.QueryString("SID"))
    End Sub
