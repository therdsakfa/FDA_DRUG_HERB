<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_JJ_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_JJ_CONFIRM" %>
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row" style="text-align: center">
                ...
                <div class="col-lg-10">
                    ...
                    <asp:Button ID="btn_cancel" runat="server" Text="ยกเลิกคำขอ" CssClass="btn-lg" Width="80%" Visible="false" />
                    <asp:Button ID="btn_cancle_request" runat="server" Text="ยกเลิกการสร้างคำขอ" CssClass="btn-lg" Width="80%" Visible="false" />
