<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_Product.Master" CodeBehind="FRM_HERB_TABEAN_NEW_WHO.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_NEW_WHO" %>
...
<%--     <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>--%>
    ...
    <div class="row">
        <div class="col-lg-12" style="text-align:center">
             <asp:Button ID="btn_tabean" runat="server" Text="ระบบขอขึ้นทะเบียน" Enabled="false"/>
            <asp:Button ID="btn_detail" runat="server" Text="ระบบขอแจ้งรายละเอียด" Enabled="false"/>
            <asp:Button ID="btn_jj" runat="server" Text="ระบบขอจดแจ้ง" />
            <asp:Button ID="btn_EX" runat="server" Text="ระบบขอผลิตภัณฑ์ตัวอย่าง" Enabled="false"/>
    ...
    <div class="row" id="T1" runat="server" Visible="false">
        ...
        <h3 class="h3"></h3>
        <div></div>
            <p class="h3">ยื่นคำขอในนามผู้ใด</p>
            <hr />
        <telerik:RadGrid ID="RadGrid1" runat="server">
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="WHO_IDA" DataType="System.Int32" FilterControlAltText="Filter WHO_IDA column"
                        HeaderText="WHO_IDA" ReadOnly="True" SortExpression="WHO_IDA" UniqueName="WHO_IDA" Display="false">
                    </telerik:GridBoundColumn>
