Public Class POP_UP_LCN_TRANSFER_UPLOAD_FILE
        ...
        For Each tr As TableRow In tb_type_menu.Rows
            ...
            If f.HasFile Then
                ...
                If exten.ToUpper = "PDF" Then
                    ...
                    Dim Name_fake As String = "TRF-" & _ProcessID & "-" & Date.Now.Year & "-" & tr_id & ".pdf"
                    dao_f.fields.NAME_FAKE = Name_fake
                    dao_f.fields.NAME_REAL = f.FileName
                    dao_f.fields.CREATE_DATE = Date.Now
                    dao_f.update()

                    Dim paths As String = bao._PATH_XML_PDF_LCN_TRANSFER
