<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_LCN_DRUG_TRANSFER_SEARCH.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_DRUG_TRANSFER_SEARCH" %>
    ...
    <div class="panel" style="text-align: left; width: 100%">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <h4> &nbsp;&nbsp;ใบ<asp:Label ID="lbl_name_2" runat="server" Text=""></asp:Label><asp:Label ID="lbl_name" runat="server" Text=""></asp:Label>
                </h4>
            </div>
