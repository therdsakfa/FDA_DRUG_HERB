<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_DH_PRINT.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_DH_PRINT" %>
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <table class="table" style="width:90%"> 
                     ...
                     <tr><td><asp:Button ID="btn_close" runat="server" Text="ปิดหน้าต่าง" CssClass="btn-lg"   Width="80%" /></td></tr>
                     <tr><td> &nbsp;</td></tr>
                     <tr><td>  &nbsp;</td></tr>
                     <tr><td>  &nbsp;</td></tr>
