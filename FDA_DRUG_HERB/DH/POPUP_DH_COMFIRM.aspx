<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_DH_COMFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_DH_COMFIRM" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <link href="../css/css_main.css" rel="stylesheet" />
    <script type="text/javascript" >
        ...
        $(function () {
            $('#<%= btn_confirm.ClientID%>').click(function () {
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <table class="table" style="width:90%"> 
                     ...
                     <tr><td><asp:Button ID="btn_confirm" runat="server" Text="ยื่นคำขอ" CssClass="btn-lg"   Width="80%" OnClientClick="return confirm('คุณต้องการต้องการยื่นคำขอหรือไม่');" /></td></tr>
                     <tr><td> <asp:Button ID="btn_cancel" runat="server" Text="ยกเลิก" CssClass="btn-lg"   Width="80%"/></td></tr>
                     <tr><td>  <asp:Button ID="btn_load" runat="server" Text="ดูด้วย Reader" CssClass="btn-lg"   Width="80%" /></td></tr>
                     
                     
                     
                     <tr><td>  <asp:Button ID="btn_load0" runat="server" Text="กลับหน้ารายการ" CssClass="btn-lg"  Visible="false"  Width="80%" /></td></tr>

                 </table>
                 
                 <asp:Panel ID="Panel1" runat="server" style="display:none;">
                        <asp:Button ID="btn_reload" runat="server" Text="Reload PDF" CssClass="btn-lg"   Width="80%" />
                </asp:Panel>
