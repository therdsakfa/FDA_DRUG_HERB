...
Public Class FRM_RQT_ALL_STOPTIME
    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "del" Then
                ...
                AddLogStatusEtracking(999, Request.QueryString("type"), _CLS.CITIZEN_ID, "ลบ" & dao_pe.fields.PERIOD_NAME & " ครั้งที่ " & dao.fields.PERIOD_COUNT, dao.fields.IDA, 0)
            ...
            ElseIf e.CommandName = "_date" Then
                Dim url As String = "FRM_RQT_ALL_STOPTIME_DATE.aspx?id_r=" & Request.QueryString("id_r") & "&ida=" & item("IDA").Text & "&type=" & Request.QueryString("type")
    ...
    Private Sub RadGrid1_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        Else
            '
            dt = bao.SP_GET_E_TRACKING_STOP_DAY_V3(Request.QueryString("id_r"), Request.QueryString("type"))
    ...
    Private Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        ...
        With dao.fields
            ...
            Try
                ...
                .PRODUCT_TYPE = Request.QueryString("type")
            ...
            End Try
            If Request.QueryString("id_r") <> "" Then
                .TYPE_P = Request.QueryString("type")
        ...
        AddLogStatusEtracking(0, Request.QueryString("type"), _CLS.CITIZEN_ID, "เพิ่ม" & ddl_period.SelectedItem.Text & " ครั้งที่ " & ddl_period_count.SelectedItem.Text, dao.fields.IDA, 0)
