    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "report" Then
                ...
                Dim url2 As String = "../E_TRACKING/FRM_RQT_ALL_STOPTIME.aspx?id_r=" & id_r & "&type=" & RadioButtonList1.SelectedValue
    ...
    Private Sub RadGrid1_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        Try
            If RadioButtonList1.SelectedValue = "1" Then
                dt = bao.SP_drrqt_Etracking(txt_type_request.Text)
            ElseIf RadioButtonList1.SelectedValue = "2" Then
                dt = bao.SP_DRRGT_EDIT_REQUEST_Etracking(txt_type_request.Text)
            End If
