...
Public Class FRM_E_TRACKING_SUB_WORK_GRAPH
    ...
    Sub bind_graph_new()
        ...
        For Each dr As DataRow In dt.Rows
            ...
            dr("less120") = dt_list.Compute("count(IDA)", "day_cal > '" & dt2(0)("max_gap") & "' and wrkuntcd='" & gid & "' and COL4='" & dr("COL4") & "' and COL5='" & dr("COL5") & "'")
            dr("less60_to_120") = dt_list.Compute("count(IDA)", "day_cal > '" & dt2(1)("gap") & "' and day_cal <= '" & dt2(1)("max_gap") & "' and wrkuntcd='" & gid & "' and COL4='" & dr("COL4") & "' and COL5='" & dr("COL5") & "'")
            dr("less0_to_60") = dt_list.Compute("count(IDA)", "day_cal >= '" & dt2(2)("gap") & "' and day_cal < '" & dt2(2)("max_gap") & "' and wrkuntcd='" & gid & "' and COL4='" & dr("COL4") & "' and COL5='" & dr("COL5") & "'")
            dr("more0_to_60") = dt_list.Compute("count(IDA)", "day_cal >= '" & dt2(3)("max_gap") & "' and day_cal < '" & dt2(3)("gap") & "' and wrkuntcd='" & gid & "' and COL4='" & dr("COL4") & "' and COL5='" & dr("COL5") & "'")
            dr("more60_to_120") = dt_list.Compute("count(IDA)", "day_cal < '" & dt2(4)("gap") & "' and day_cal >= '" & dt2(4)("max_gap") & "' and wrkuntcd='" & gid & "' and COL4='" & dr("COL4") & "' and COL5='" & dr("COL5") & "'")
            dr("more120") = dt_list.Compute("count(IDA)", "day_cal < '" & dt2(5)("max_gap") & "' and wrkuntcd='" & gid & "' and COL4='" & dr("COL4") & "' and COL5='" & dr("COL5") & "'")
        ...
        If dt.Rows.Count > 0 Then
            ...
            For Each dr As DataRow In dt.Rows
                ...
                datum.link = "../E_TRACKING/FRM_E_TRACKING_PERSON_GRAPH.aspx?gid=" & Request.QueryString("gid") & "&col4=" & dr("COL4") & "&col5=" & col5 & "&t=1&g=" & Request.QueryString("g")
                datase.data.Add(datum)

                Dim datum2 As New Datum
                datum2.value = dr("less60_to_120")
                datum2.link = "../E_TRACKING/FRM_E_TRACKING_PERSON_GRAPH.aspx?gid=" & Request.QueryString("gid") & "&col4=" & dr("COL4") & "&col5=" & col5 & "&t=2&g=" & Request.QueryString("g")
                datase2.data.Add(datum2)

                Dim datum3 As New Datum
                datum3.value = dr("less0_to_60")
                datum3.link = "../E_TRACKING/FRM_E_TRACKING_PERSON_GRAPH.aspx?gid=" & Request.QueryString("gid") & "&col4=" & dr("COL4") & "&col5=" & col5 & "&t=3&g=" & Request.QueryString("g")
                datase3.data.Add(datum3)

                Dim datum4 As New Datum
                datum4.value = dr("more0_to_60")
                datum4.link = "../E_TRACKING/FRM_E_TRACKING_PERSON_GRAPH.aspx?gid=" & Request.QueryString("gid") & "&col4=" & dr("COL4") & "&col5=" & col5 & "&t=4&g=" & Request.QueryString("g")
                datase4.data.Add(datum4)

                Dim datum5 As New Datum
                datum5.value = dr("more60_to_120")
                datum5.link = "../E_TRACKING/FRM_E_TRACKING_PERSON_GRAPH.aspx?gid=" & Request.QueryString("gid") & "&col4=" & dr("COL4") & "&col5=" & col5 & "&t=5&g=" & Request.QueryString("g")
                datase5.data.Add(datum5)

                Dim datum6 As New Datum
                datum6.value = dr("more120")
                datum6.link = "../E_TRACKING/FRM_E_TRACKING_PERSON_GRAPH.aspx?gid=" & Request.QueryString("gid") & "&col4=" & dr("COL4") & "&col5=" & col5 & "&t=6&g=" & Request.QueryString("g")
