<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_SEARCH_A.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_SEARCH_A" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2>ค้นหาการติดตามคำขอด้านยา (ทั้งหมด)</h2>
   ...
   <div>
       <table width="100%">
           <tr>
            ...
            <tr>
                <td>ชื่อจนท.ที่รับผิดชอบ</td>
                <td Width="70%">
                                <asp:TextBox ID="txt_r_no0" runat="server" CssClass="input-lg" Width="70%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                       ...
                       <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA" NoMasterRecordsText="ไม่พบข้อมูล">
                           ...
                           <Columns>
                               ...
                               <telerik:GridBoundColumn DataField="REQUEST_DATE" FilterControlAltText="Filter REQUEST_DATE column"
                                   HeaderText="วันที่ของสถานะล่าสุด" SortExpression="REQUEST_DATE" UniqueName="REQUEST_DATE" DataType="System.DateTime" DataFormatString="{0:dd/MM/yyyy}">
                               </telerik:GridBoundColumn>
