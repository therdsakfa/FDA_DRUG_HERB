<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_E_Tracking.Master" CodeBehind="FRM_E_TRACKING_WORK.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_E_TRACKING_WORK" %>
                   ...
                   <table>
                       <tr>
                           <td>
                               &nbsp;</td>
                           <td>
                               <asp:TextBox ID="txt_citizen" runat="server" CssClass="btn-lg" Width="300px"></asp:TextBox>
