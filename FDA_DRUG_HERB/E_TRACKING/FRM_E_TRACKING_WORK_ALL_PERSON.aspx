<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_E_Tracking.Master" CodeBehind="FRM_E_TRACKING_WORK_ALL_PERSON.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_E_TRACKING_WORK_ALL_PERSON" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2> รายงานคำขอที่รอการพิจารณารายบุคคล ตามกลุ่มงาน</h2>
   ...
   <div>
       <table width="100%">
           ...
           <asp:HiddenField ID="HiddenField1" runat="server" Value="1234" />
                   ...
                   <asp:DropDownList ID="DropDownList1" runat="server" DataValueField="wrkuntcd" DataTextField="wrkuntnm">
                   </asp:DropDownList>
                   <asp:Button ID="Button1" runat="server" Text="ดูข้อมูล" />
               </td>
           </tr>
           <tr>
               <td>
                   <telerik:RadGrid ID="RadGrid1" runat="server" Width="100%" AutoGenerateColumns="false" ShowFooter="true">
                  <MasterTableView>
                      <Columns>
                         ...
                         <%-- <telerik:GridBoundColumn DataField="less120" FilterControlAltText="Filter less120 column"
                          ...
                          <telerik:GridBoundColumn DataField="total" FilterControlAltText="Filter total column"
                           HeaderText="รวม" SortExpression="total" UniqueName="total" Aggregate="Sum" FooterText="รวมทั้งหมด ">
                              <ItemStyle HorizontalAlign="Right" />
                       </telerik:GridBoundColumn>
                      </Columns>
                  </MasterTableView>
