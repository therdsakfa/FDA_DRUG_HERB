...
Public Class FRM_E_TRACKING_PERSON_GRAPH2
    ...
    Sub bind_graph_new()
        ...
        If Request.QueryString("ctzid") <> "" Then
            dt = bao.SP_E_TRACKING_PERSON_WORK_BY_CTZID(Request.QueryString("ctzid"))
        Else
        ...
        If Request.QueryString("ctzid") <> "" Then
            ...
            dt_list = bao_list.SP_E_TRACKING_WORK_LIST_ALL_BY_CTZID_V2(Request.QueryString("ctzid"))
        Else
        ...
        If dt.Rows.Count > 0 Then
            ...
            For Each dr As DataRow In dt.Rows
                ...
                If Request.QueryString("ctzid") <> "" Then
                    datum.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON.aspx?gid=" & Request.QueryString("gid") & _
                     "&col5=" & Request.QueryString("col5") & "&iden=" & dr("ctzid") & "&t=1&g=" & Request.QueryString("g") & "&p=1"
                Else
                    datum.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH2.aspx?gid=" & Request.QueryString("gid") & _
                ...
                If Request.QueryString("ctzid") <> "" Then
                    datum2.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON.aspx?gid=" & Request.QueryString("gid") & _
                     "&iden=" & dr("ctzid") & "&t=2&g=" & Request.QueryString("g") & "&p=1"
                Else
                    datum2.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH2.aspx?gid=" & Request.QueryString("gid") & _
                ...
                If Request.QueryString("ctzid") <> "" Then
                    datum3.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON.aspx?gid=" & Request.QueryString("gid") & _
                    "&iden=" & dr("ctzid") & "&t=3&g=" & Request.QueryString("g") & "&p=1"
                Else
                    datum3.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH2.aspx?gid=" & Request.QueryString("gid") & _
                ...
                If Request.QueryString("ctzid") <> "" Then
                    datum4.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON.aspx?gid=" & Request.QueryString("gid") & _
                     "&iden=" & dr("ctzid") & "&t=4&g=" & Request.QueryString("g") & "&p=1"
                Else
                    datum4.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH2.aspx?gid=" & Request.QueryString("gid") & _
                ...
                If Request.QueryString("ctzid") <> "" Then
                    datum5.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON.aspx?gid=" & Request.QueryString("gid") & _
                    "&iden=" & dr("ctzid") & "&t=5&g=" & Request.QueryString("g") & "&p=1"
                Else
                    datum5.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH2.aspx?gid=" & Request.QueryString("gid") & _
                ...
                If Request.QueryString("ctzid") <> "" Then
                    datum6.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON.aspx?gid=" & Request.QueryString("gid") & _
                    "&iden=" & Trim(dr("ctzid")) & "&t=6&g=" & Request.QueryString("g") & "&p=1"
                Else
                    datum6.link = "../NEW/FRM_E_TRACKING_SUB_WORK_GRAPH2.aspx?gid=" & Request.QueryString("gid") & _
    ...
    Private Sub btn_back_Click(sender As Object, e As EventArgs) Handles btn_back.Click
        Response.Redirect("../NEW/FRM_E_TRACKING_GROUP_HEAD.aspx?g=" & Request.QueryString("g"))
    End Sub
