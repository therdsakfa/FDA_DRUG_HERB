<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_E_Tracking.Master" CodeBehind="FRM_E_TRACKING_PERSON_DETAIL_TABLE_NEW.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_E_TRACKING_PERSON_DETAIL_TABLE_NEW" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2> รายงานคำขอที่รอการพิจารณารายบุคคล</h2>
