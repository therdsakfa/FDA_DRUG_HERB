...
Public Class FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            '    dao.GetDataby_wrknutcd(Request.QueryString("g"))
            '    Try
            '        Label1.Text = dao.fields.wrkuntnm & " > ประเภททะเบียน"
            ...
            Try
                If Request.QueryString("iden") <> "" Then
                    Dim dao As New DAO_DRUG.TB_sysstaff
                    dao.GetDataby_ctzid(Request.QueryString("iden"))
                    Label1.Text = "เจ้าหน้าที่ " & dao.fields.stfthanm
                End If
            Catch ex As Exception
                Label1.Text = ""
            End Try
    ...
    Sub bind_graph_new()
        ...
        dt_list = bao_list.SP_E_TRACKING_WORK_LIST_ALL_BY_CTZID_V2(Request.QueryString("iden"))
        ...
        For Each dr As DataRow In dt.Rows
            ...
            Else
                dr("less120") = dt_list.Compute("count(IDA)", "day_cal > '" & dt2(0)("max_gap") & "' and COL5='" & dr("COL5") & "' and ctzid='" & dr("ctzid") & "'")
                dr("less60_to_120") = dt_list.Compute("count(IDA)", "day_cal > '" & dt2(1)("gap") & "' and day_cal <= '" & dt2(1)("max_gap") & "' and COL5='" & dr("COL5") & "' and ctzid='" & dr("ctzid") & "'")
                dr("less0_to_60") = dt_list.Compute("count(IDA)", "day_cal >= '" & dt2(2)("gap") & "' and day_cal < '" & dt2(2)("max_gap") & "' and COL5='" & dr("COL5") & "' and ctzid='" & dr("ctzid") & "'")
                dr("more0_to_60") = dt_list.Compute("count(IDA)", "day_cal >= '" & dt2(3)("max_gap") & "' and day_cal < '" & dt2(3)("gap") & "' and COL5='" & dr("COL5") & "' and ctzid='" & dr("ctzid") & "'")
                dr("more60_to_120") = dt_list.Compute("count(IDA)", "day_cal < '" & dt2(4)("gap") & "' and day_cal >= '" & dt2(4)("max_gap") & "' and COL5='" & dr("COL5") & "' and ctzid='" & dr("ctzid") & "'")
                dr("more120") = dt_list.Compute("count(IDA)", "day_cal < '" & dt2(5)("max_gap") & "' and COL5='" & dr("COL5") & "' and ctzid='" & dr("ctzid") & "'")
            End If
        ...
        If dt.Rows.Count > 0 Then
            ...
            For Each dr As DataRow In dt.Rows
                ...
                datum.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE_NEW.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=1&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g") & "&p=1"
                datase.data.Add(datum)

                Dim datum2 As New Datum
                datum2.value = dr("less60_to_120")
                datum2.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=2&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g") & "&p=1"
                datase2.data.Add(datum2)

                Dim datum3 As New Datum
                datum3.value = dr("less0_to_60")
                datum3.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=3&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g") & "&p=1"
                datase3.data.Add(datum3)

                Dim datum4 As New Datum
                datum4.value = dr("more0_to_60")
                datum4.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=4&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g") & "&p=1"
                datase4.data.Add(datum4)

                Dim datum5 As New Datum
                datum5.value = dr("more60_to_120")
                datum5.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=5&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g") & "&p=1"
                datase5.data.Add(datum5)

                Dim datum6 As New Datum
                datum6.value = dr("more120")
                datum6.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=6&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g") & "&p=1"
    ...
    Private Sub btn_back_Click(sender As Object, e As EventArgs) Handles btn_back.Click
        If Request.QueryString("iden") <> "" Then
            Response.Redirect("../NEW/FRM_E_TRACKING_PERSON_GRAPH2.aspx?gid=" & Request.QueryString("gid") & "&g=" & Request.QueryString("g") & "&ctzid=" & Request.QueryString("iden") & "&p=1")

        Else
            Response.Redirect("../NEW/FRM_E_TRACKING_PERSON_GRAPH2.aspx?gid=" & Request.QueryString("gid") & "&g=" & Request.QueryString("g"))
