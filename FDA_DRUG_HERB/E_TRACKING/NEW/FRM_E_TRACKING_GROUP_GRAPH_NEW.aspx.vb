...
Public Class FRM_E_TRACKING_GROUP_GRAPH_NEW
    ...
    Public Sub bind_graph_new2()
        ...
        If dt.Rows.Count > 0 Then
            ...
            For Each dr As DataRow In dt.Rows
                ...
                datum.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH_NEW.aspx?gid=" & dr("wrkuntcd") & "&t=1&g=" & Request.QueryString("g")
                datase.data.Add(datum)

                Dim datum2 As New Datum
                datum2.value = dr("less60_to_120")
                datum2.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH_NEW.aspx?gid=" & dr("wrkuntcd") & "&t=2&g=" & Request.QueryString("g")
                datase2.data.Add(datum2)

                Dim datum3 As New Datum
                datum3.value = dr("less0_to_60")
                datum3.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH_NEW.aspx?gid=" & dr("wrkuntcd") & "&t=3&g=" & Request.QueryString("g")
                datase3.data.Add(datum3)

                Dim datum4 As New Datum
                datum4.value = dr("more0_to_60")
                datum4.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH_NEW.aspx?gid=" & dr("wrkuntcd") & "&t=4&g=" & Request.QueryString("g")
                datase4.data.Add(datum4)

                Dim datum5 As New Datum
                datum5.value = dr("more60_to_120")
                datum5.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH_NEW.aspx?gid=" & dr("wrkuntcd") & "&t=5&g=" & Request.QueryString("g")
                datase5.data.Add(datum5)

                Dim datum6 As New Datum
                datum6.value = dr("more120")
                datum6.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH_NEW.aspx?gid=" & dr("wrkuntcd") & "&t=6&g=" & Request.QueryString("g")
