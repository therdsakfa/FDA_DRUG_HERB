...
Public Class FRM_E_TRACKING_GROUP_HEAD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Request.QueryString("g") <> "" Then
                ...
                Try
                    Label1.Text = dao.fields.wrkuntnm
    ...
    Public Sub bind_graph_new2()
        ...
        dt = bao.SP_E_TRACKING_WORK_GROUP_BY_GROUP3(Request.QueryString("g"))

        Dim bao_list As New BAO.ClsDBSqlcommand
        Dim dt_list As New DataTable
        dt_list = bao_list.SP_E_TRACKING_WORK_LIST_ALL_BY_GROUP3(Request.QueryString("g"))
        ...
        For Each dr As DataRow In dt_list.Rows
            ...
            End Try
            Dim date_current As Date
            Try
                date_current = CDate(dr("appdate"))
            Catch ex As Exception
                date_current = Date.Now
            End Try
            If days < 0 Then
                Dim holiday2 As Integer = 0
                ws = New WS_GETDATE_WORKING.BasicHttpBinding_IService1
                ws.GETDATE_COUNT_DAY(date_t, True, date_current, True, holiday2, True)
                days += holiday2
            End If
        ...
        If dt.Rows.Count > 0 Then
            ...
            For Each dr As DataRow In dt.Rows
                ...
                datum.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH2.aspx?gid=" & dr("wrkuntcd") & "&t=1&g=" & Request.QueryString("g")
                datase.data.Add(datum)

                Dim datum2 As New Datum
                datum2.value = dr("less60_to_120")
                datum2.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH2.aspx?gid=" & dr("wrkuntcd") & "&t=2&g=" & Request.QueryString("g")
                datase2.data.Add(datum2)

                Dim datum3 As New Datum
                datum3.value = dr("less0_to_60")
                datum3.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH2.aspx?gid=" & dr("wrkuntcd") & "&t=3&g=" & Request.QueryString("g")
                datase3.data.Add(datum3)

                Dim datum4 As New Datum
                datum4.value = dr("more0_to_60")
                datum4.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH2.aspx?gid=" & dr("wrkuntcd") & "&t=4&g=" & Request.QueryString("g")
                datase4.data.Add(datum4)

                Dim datum5 As New Datum
                datum5.value = dr("more60_to_120")
                datum5.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH2.aspx?gid=" & dr("wrkuntcd") & "&t=5&g=" & Request.QueryString("g")
                datase5.data.Add(datum5)

                Dim datum6 As New Datum
                datum6.value = dr("more120")
                datum6.link = "../NEW/FRM_E_TRACKING_PERSON_GRAPH2.aspx?gid=" & dr("wrkuntcd") & "&t=6&g=" & Request.QueryString("g")
