...
Public Class FRM_E_TRACKING_SUB_WORK_GRAPH2
    ...
    Sub bind_graph_new()
        ...
        If dt.Rows.Count > 0 Then
            ...
            For Each dr As DataRow In dt.Rows
                ...
                End Try
                'FRM_E_TRACKING_SUB_WORK_GRAPH_ONLY_PERSON
                ...
                datum2.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=2&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g")
                datase2.data.Add(datum2)

                Dim datum3 As New Datum
                datum3.value = dr("less0_to_60")
                datum3.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=3&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g")
                datase3.data.Add(datum3)

                Dim datum4 As New Datum
                datum4.value = dr("more0_to_60")
                datum4.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=4&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g")
                datase4.data.Add(datum4)

                Dim datum5 As New Datum
                datum5.value = dr("more60_to_120")
                datum5.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=5&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g")
                datase5.data.Add(datum5)

                Dim datum6 As New Datum
                datum6.value = dr("more120")
                datum6.link = "../NEW/FRM_E_TRACKING_PERSON_DETAIL_TABLE2.aspx?gid=" & Request.QueryString("gid") & "&col5=" & col5 & "&t=6&iden=" & Request.QueryString("iden") & "&g=" & Request.QueryString("g")
