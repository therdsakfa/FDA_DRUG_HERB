<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_DRRGT_STATUS_POPUP.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DRRGT_STATUS_POPUP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%" class="table">
        <tr>
            <td align="right" style="width:20%;">สถานะต่อไป :</td>
            <td >
