<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_ETRACKING_STATUS_HEAD_MAIN_RQ_CENTER.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_ETRACKING_STATUS_HEAD_MAIN_RQ_CENTER" %>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td>
                        &nbsp;</td>
                    <td>
<asp:Button ID="btn_add" runat="server" Text="เพิ่มช่วงสถานะ" OnClientClick="return confirm('ต้องการเพิ่มช่วงสถานะหรือไม่');" CssClass="btn-lg "/>
                    </td>
                </tr>
                <%--<tr>
           ...
           <MasterTableView>
               <Columns>
                 ...
                 <telerik:GridBoundColumn UniqueName="END_DATE" DataField="END_DATE" HeaderText="วันสิ้นสุดกระบวนการ" DataFormatString="{0:d}">
                   ...
                   <telerik:GridButtonColumn ButtonType="LinkButton" CommandName="expert" Text="ผู้เชี่ยวชาญ" UniqueName="btn_expert">
                   </telerik:GridButtonColumn>
                   <telerik:GridButtonColumn ButtonType="LinkButton" CommandName="sel" Text="ปรับสถานะ" UniqueName="btn_sel" Visible="false">
                   </telerik:GridButtonColumn>
               </Columns>
           </MasterTableView>
       </telerik:RadGrid>
