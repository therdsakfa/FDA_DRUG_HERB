<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_EXPERT_ASSIGN_V4.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_EXPERT_ASSIGN_V4" %>
                    ...
                    AllowPaging="true" PageSize="10">
                        ...
                        <MasterTableView>
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn UniqueName="TIME_START_DATE" HeaderText="วันเริ่มต้นประเมิน">
                                <ItemTemplate>
                                    <telerik:RadDatePicker ID="rd_startdate" runat="server"></telerik:RadDatePicker>
                                    <asp:Label ID="lbl_statdate" runat="server" Text="" style="display:none;"></asp:Label>
                                </ItemTemplate>
                                ...
                                <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_date" Text="เพิ่มวันสิ้นสุด" CommandName="_date">
