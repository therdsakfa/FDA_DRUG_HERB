...
Public Class FRM_E_TRACKING_CONFIRM
    ...
    Protected Sub btn_confirm_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        ...
        'dao.GetDataby_TRANSECTION_ID_UPLOAD(_CLS.TRANSECTION_UP_ID)
        ...
        dao_date.fields.STATUS_GROUP = 3
        dao_date.fields.STATUS_ID = ddl_cnsdcd.SelectedValue

        dao_date.insert()
        'fusion_XML_To_PDF_Output("DA-41-2558-" & _CLS.IDA.ToString())
        ...
        '    '------------------
        '    Dim dao As New DAO_DRUG.ClsDBdrrgt
        '    'dao.GetDataby_IDA(Integer.Parse(dao_up.fields.REF_NO))
        '    dao.GetDataby_IDA(_IDA)
        '    dao.fields.cnccscd = Integer.Parse(ddl_cnsdcd.SelectedValue())
        '    dao.fields.STATUS_ID = ddl_cnsdcd.SelectedValue
        '    dao.fields.cnccd = 0
    ...
    Protected Sub btn_cancel_Click(sender As Object, e As EventArgs) Handles btn_cancel.Click
        ...
        ' Response.Redirect("FRM_STAFF_VIEWS.aspx")
    End Sub

    Protected Sub btn_load_Click(sender As Object, e As EventArgs) Handles btn_load.Click
        'Dim dao As New DAO.clsDBfregntf
        'dao.GetDataby_ID(Integer.Parse(_ID))
        'If dao.fields.lcntypecd = 11 Then
        '    'fusion_XML_To_PDF(dao.fields.xmlnm)

        '    fusion_XML_To_PDF("FA-5-2558-" & _ID.ToString())
        'Else
        '    ' fusion_XML_To_PDF2(dao.fields.xmlnm)
        '    fusion_XML_To_PDF("FA-5-2558-" & _ID.ToString())
        'End If
    End Sub
    ...
    Protected Sub ddl_cnsdcd_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddl_cnsdcd.SelectedIndexChanged
        'If ddl_cnsdcd.SelectedValue = 1 Then
        '    lbl_fdpdtno.Visible = True
        '    lbl_remark.Text = "เลขสารบบ"
        '    ' txt_fdpdtno.Visible = True
        '    txt_remark.Visible = False
        '    lbl_fdpdtno2.Visible = True
        'ElseIf ddl_cnsdcd.SelectedValue = 2 Then
        '    lbl_fdpdtno.Visible = False
        '    lbl_remark.Text = "หมายเหตุ"
        '    ' txt_fdpdtno.Visible = False
        '    txt_remark.Visible = True
        '    lbl_fdpdtno2.Visible = False
        'End If
    End Sub
