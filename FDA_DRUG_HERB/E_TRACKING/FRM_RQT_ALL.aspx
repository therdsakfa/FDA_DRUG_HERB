<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_RQT_ALL.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_RQT_ALL" %>
            ...
            <tr>
                ...
                <td Width="70%" align="left">
                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1" Selected="True">คำขอขึ้นทะเบียน</asp:ListItem>
                                    <asp:ListItem Value="2">คำขอแก้ไขทะเบียน</asp:ListItem>
                                </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
