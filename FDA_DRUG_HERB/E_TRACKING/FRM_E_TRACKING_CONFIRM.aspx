<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_E_TRACKING_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_E_TRACKING_CONFIRM" %>
                 ...
                 <table class="table" style="width:90%"> 
                     ...
                     <tr><td>
                         <asp:DropDownList ID="ddl_cnsdcd" runat="server" AutoPostBack="True" Width="80%" DataTextField="STATUS_NAME" DataValueField="STATUS_ID">
                             <%--<asp:ListItem Value="6">อนุมัติ</asp:ListItem>
