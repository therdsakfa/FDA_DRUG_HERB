<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FRM_DS_NORYORBOR8.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DS_NORYORBOR8" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<%@ Register Src="~/DS/UC/UC_DS_NORYORBOR8.ascx" TagPrefix="uc1" TagName="UC_DS_NORYORBOR8" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <uc1:UC_DS_NORYORBOR8 runat="server" ID="UC_DS_NORYORBOR8" />
        </div>
    </form>
</body>
</html>
