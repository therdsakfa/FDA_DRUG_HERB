<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_DS_NORYORMOR2.ascx.vb" Inherits="FDA_DRUG_HERB.UC_DS_NORYORMOR2" %>
    ...
    <tr>
        ...
        <tr>
            ...
            <td class="auto-style11">
                ...
                <br />
                <asp:Radiobutton ID="CheckBox6" Text="ผู้รับอนุญาตผลิตยา" runat="server" GroupName="in_name"/>
                <br />
                <asp:Radiobutton ID="CheckBox7" Text="ผู้รับอนุญาตนำหรือสั่งยาฯ ณ สถานที่ชื่อ" runat="server" GroupName="in_name"/>
...
&nbsp;
                ...
                <tr >
                        <td colspan="2" >
                <telerik:RadGrid ID="RadGrid2" runat="server" GridLines="None" width="50%" ShowFooter="true"  AutoGenerateColumns="false" align="Center"> 
                   <MasterTableView>
                        <Columns>
