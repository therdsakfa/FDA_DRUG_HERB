<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_DS_NORYORMOR4.ascx.vb" Inherits="FDA_DRUG_HERB.UC_DS_NORYORMOR4"%>
    ...
    <tr>
        ...
        <td>
         ...
         <tr>
          ...
          <tr>
            ...
            <td>
                <asp:RadioButton  ID="chk_for1" runat="server" GroupName="for" Text="แผนปัจจุบัน เข้ามาในราชอาณาจักรเพื่อบริจาคเพื่อการกุศล"></asp:RadioButton>
                <br />
                <asp:RadioButton ID="chk_for2" runat="server" GroupName="for"  Text="แผนโบราณ เข้ามาในราชอาณาจักรเพื่อบริจาคเพื่อการกุศล" AutoPostBack="True"></asp:RadioButton> 
            </td>
        </tr>
        <tr>
            <td align="right" class="auto-style3">
        ...
        <tr>
            ...
            <td class="auto-style11">
                ...
                <br />
                <asp:Radiobutton ID="CheckBox3" Text="กรม" runat="server" GroupName="in_name"/>
                
                <asp:DropDownList ID="kom" runat="server">
                    <asp:ListItem></asp:ListItem>      
...
<table class="table" style="width:100%;">
    ...
    <%-- <tr>
        ...
        <tr>
            <td align="right" class="auto-style3">
                บริจาคเพื่อการกุศลให้แก่ :</td>
            <td>
                <asp:RadioButton ID="RadioButton1" runat="server" GroupName="Company_type" Text="ภาครัฐฯ" />
&nbsp;&nbsp;
                <asp:RadioButton ID="RadioButton2" runat="server" GroupName="Company_type" Text="ภาคเอกชน" />
                <br />
                <br />
                เลขนิติบุคคล :&nbsp;
                <asp:TextBox ID="txt_togive" runat="server"></asp:TextBox>
                <%--&nbsp;<asp:button ID="btn_search0" runat="server" Text="ค้นหา"></asp:button>
            &nbsp;(เลขนิติบุุคคน)
                <br />
                <asp:Label ID="lbl_givefornm" runat="server"></asp:Label>--%>&nbsp;<asp:Button ID="Button4" runat="server" Text="ค้นหา" />
                <br />
                <asp:DropDownList ID="DropDownList1" runat="server" DataTextField="thanameplace" DataValueField="IDA">

                </asp:DropDownList>
&nbsp;<asp:Button ID="Button5" runat="server" Text="เพิ่ม" />
                <br />
                <asp:Label ID="Label3" runat="server"></asp:Label>
                <asp:HiddenField ID="location_addr_ida" runat="server" />
            </td>
        </tr>
    <tr>
        <td align="right" class="auto-style3">
...
&nbsp;
        ...
        <td>
         ...
         <tr id="package2" runat="server" style="display:none;">
            <td align="right" class="auto-stylee3">
                <%--<asp:CheckBox ID="chk_size" runat="server" Text="เพิ่มขนาดบรรจุ :" AutoPostBack="true"></asp:CheckBox>--%>เพิ่มขนาดบรรจุ
                </td>
