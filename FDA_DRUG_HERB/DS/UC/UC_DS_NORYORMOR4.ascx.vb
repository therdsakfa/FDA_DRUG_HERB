...
Imports FDA_DRUG_HERB.DAO_DRUG
Imports FDA_DRUG_HERB.XML_CENTER
Imports Telerik.Web.UI

Public Class UC_DS_NORYORMOR4
    Inherits System.Web.UI.UserControl
    Public _process As String = "1029"
    ...
    Public Sub set_label(ByVal lcnno_display As String)
        ...
        Else
            ...
            unit_physic.GetDataby_IDA(dao_package.fields.SMALL_UNIT)
        ...
        Else
            ...
            Else
                ...
                Else
                    ...
                    Else
                        If txt_togive.Text = "" Then
                            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('กรุณากรอกบริจาคเพื่อการกุศลให้แก่');", True)
                        Else
    ...
    Sub after_save()
        ...
        ElseIf CheckBox6.Checked = True Then
            ...
            save.fields.pootane = txt_phoothane.Text
        ElseIf CheckBox7.Checked = True Then
            save.fields.IN_NAME = "7"
            save.fields.samakom = txt_samakom.Text
        ElseIf CheckBox8.Checked = True Then
            save.fields.IN_NAME = "8"
            save.fields.moolniti = txt_moolniti.Text
        ElseIf CheckBox9.Checked = True Then
            save.fields.IN_NAME = "9"
        ElseIf CheckBox10.Checked = True Then
            save.fields.IN_NAME = "10"
        End If

        If RadioButton1.Checked = True Then
            save.fields.donate_type = 1 'ภาครัฐ
        ElseIf RadioButton2.Checked = True Then
            save.fields.donate_type = 2 'ภาคเอกชน
        End If

        save.fields.lcntpcd = "นยม4"

        save.fields.thadrgnm = lbl_drugthanm.Text
        save.fields.engdrgnm = lbl_drugengnm.Text
        save.fields.give_to = Label3.Text
        ...
        'เพิ่มสถาณที่ตั้ง ที่บริจาคในตาราง detail
        Dim placnm As Array
        Dim ida As Array
        Dim i As Integer
        placnm = Label3.Text.Split(",")
        ida = location_addr_ida.Value.Split(",")

        Dim dao_detail As New DAO_DRUG.ClsDB_nym4_donate_detail
        For i = 0 To placnm.Length - 1

            dao_detail.fields.DRSAMP_FK_IDA = save.fields.IDA
            dao_detail.fields.place_name = placnm(i)
            dao_detail.fields.LOCATION_ADDRESS_FK_IDA = CInt(ida(i))
            dao_detail.insert()
            dao_detail = New DAO_DRUG.ClsDB_nym4_donate_detail
    ...
    Sub xml(ByVal drsamp_ida As Integer)
        ...
        'Dim file_PDF As String = paths & "PDF_TRADER_DOWNLOAD\ " & process & " Product_ID_" + dao.fields.RCVNO_DISPLAY + ".pdf"

        Dim dao_drsamp As New DAO_DRUG.ClsDBdrsamp
        dao_drsamp.GetDataby_IDA(drsamp_ida)
    ...
    '    dao.GetDataby_identify(txt_togive.Text)
    '    lbl_givefornm.Text = dao.fields.prefixnm2 + " " + dao.fields.thanm + " " + dao.fields.thalnm
    'End Sub
    ...
    Protected Sub btn_package_Click(sender As Object, e As EventArgs) Handles btn_package.Click
        ...
        '    Size_Radgrid(dao_drugname.fields.IDA)
        'End If
        Response.Redirect("../DS/FRM_DS_DRUG8_ADD.aspx?main_ida=" & txt_main_ida.Text & "&process=" & _process & "&write_at=" & txt_WRITE_AT.Text)
    End Sub
    ...
    Protected Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If dao.fields.IDENTIFY = "" Then
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('เลขนิติบุคคลไม่ถูกต้อง');", True)
        End If
    End Sub
    ...
    Protected Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Else
            Label3.Text = Label3.Text & "," & DropDownList1.SelectedItem.Text
        End If
        If location_addr_ida.Value = "" Then
            location_addr_ida.Value = DropDownList1.SelectedValue
        Else
            location_addr_ida.Value = location_addr_ida.Value & "," & DropDownList1.SelectedValue
        End If
    End Sub
