...
Public Class FRM_DS_SEARCH
    ...
    Private Sub load_ddl()
        ...
        dt = bao.SP_DDL_DRSAMP_DS(_CLS.CITIZEN_ID_AUTHORIZE, _process)
        'dao.GetDataby_FK_IDA_and_PROCESS_ID_AND_IDEN2(_CLS.CITIZEN_ID_AUTHORIZE)
    ...
    Protected Sub GV_lcnno_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GV_lcnno.RowCommand
        ...
        If e.CommandName = "sel" Then
            ...
            Try
                ...
                Dim dao_tr As New DAO_DRUG.ClsDBTRANSACTION_UPLOAD
                dao_tr.GetDataby_IDA(dao_p.fields.TR_ID)
                If _process >= 1701 And _process <= 1705 Then
                    Response.Redirect("../DS/FRM_DS_MAIN.aspx?lcn_ida=" & str_ID & "&lct_ida=" & dao.fields.FK_IDA & "&process=" & _process)
