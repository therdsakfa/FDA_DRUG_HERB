...
Namespace WS_CREATE_XML
    ...
    Partial Public Class WS_INSERT_XML_DRUG
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.FDA_DRUG_HERB.My.MySettings.Default.FDA_DRUG_HERB_WS_CREATE_XML_WS_INSERT_XML_DRUG
        ...
        Public Function XML_DRUG_DH_DI_DP_DS(ByVal Newcode As String, ByVal IDENTIFY_EDIT As String) As Object
            Dim results() As Object = Me.Invoke("XML_DRUG_DH_DI_DP_DS", New Object() {Newcode, IDENTIFY_EDIT})
            Return CType(results(0),Object)
        End Function
        
        '''<remarks/>
        Public Overloads Sub XML_DRUG_DH_DI_DP_DSAsync(ByVal Newcode As String, ByVal IDENTIFY_EDIT As String)
            Me.XML_DRUG_DH_DI_DP_DSAsync(Newcode, IDENTIFY_EDIT, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub XML_DRUG_DH_DI_DP_DSAsync(ByVal Newcode As String, ByVal IDENTIFY_EDIT As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("XML_DRUG_DH_DI_DP_DS", New Object() {Newcode, IDENTIFY_EDIT}, Me.XML_DRUG_DH_DI_DP_DSOperationCompleted, userState)
        End Sub
