Public Class POPUP_TABEAN_HERB_DONATE_ADD
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        UC_DONATE_DETAIL.save_data(dao)
        ...
        dao_up_mas.GetdatabyID_TYPE(211)
    ...
    Sub alert_summit(ByVal text As String, ByVal ida As Integer)
        Dim url As String = ""
        url = "POPUP_TABEAN_HERB_DONATE_UPLOAD.aspx?IDA=" & ida & "&PROCESS_ID=" & _PROCESS_ID & "&IDA_LCN=" & _IDA_LCN
