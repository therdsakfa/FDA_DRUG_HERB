...
Public Class UC_DONATE_DETAIL
    ...
    Sub GET_DATA()
        ...
        txt_date_DNStart.Text = Date.Now
        txt_date_DNEnd.Text = Date.Now
    End Sub
    ...
    End Sub
    Sub save_data(ByVal dao As DAO_TABEAN_HERB.TB_TABEAN_DONATE)
        With dao.fields
            .DONATE_NM = txt_NAME.Text
            .LCN_THANAMEPLACE = txt_lcn_name.Text
            .LCNNO_NEW = txt_lcnno_new.Text
            .PRODUCT_DONATE_NM = txt_drug_name.Text
            .PRODUCT_DONATE_NUMBER = txt_num.Text
            .RANK_DONATE = txt_position.Text
            .DONATE_FULLNAME = txt_position.Text & " " & txt_NAME.Text
            .WRITE_AT = Txt_Write_At.Text
            .DONATE_TO = txt_donate_to.Text
            Try
                .DONATE_NOUN_ID = rdl_behalf_in.SelectedValue
                .DONATE_NOUN = rdl_behalf_in.SelectedItem.Text
            Catch ex As Exception

            End Try
            .WRITE_DATE = txt_Write_Date.Text
            Try
                .DONATE_DATE_START = txt_date_DNStart.Text
                .DONATE_DATE_END = txt_date_DNEnd.Text
            Catch ex As Exception

            End Try
            Try
                .CATEGORY_ID = rdl_process_dn.SelectedValue
                .CATEGORY_NM = rdl_process_dn.SelectedItem.Text
            Catch ex As Exception
    ...
    Protected Sub btn_size_pack_Click(sender As Object, e As EventArgs) Handles btn_size_pack.Click
        Dim dao As New DAO_TABEAN_HERB.TB_TABEAN_DONATE_PACKING_SIZE
    ...
    Private Sub bind_size()
        Dim dao_size As New DAO_TABEAN_HERB.TB_TABEAN_DONATE_PACKING_SIZE
