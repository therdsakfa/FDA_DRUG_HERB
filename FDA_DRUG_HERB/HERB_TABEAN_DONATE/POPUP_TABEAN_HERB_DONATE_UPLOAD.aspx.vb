Public Class POPUP_TABEAN_HERB_DONATE_UPLOAD
    ...
    Sub alert_normal(ByVal text As String)
        Dim url As String = ""
        url = "FRM_TABEAN_HERB_ANALYZE.aspx?IDA_LCT=" & _IDA_LCT & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA & "&SID=" & _SID
    ...
    Sub alert_file_error(ByVal text As String)
        Dim url As String = ""
        url = "POPUP_TABEAN_SUBSTITUTE_UPLOAD.aspx?IDA_LCT=" & _IDA_LCT & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA & "&SID=" & _SID
        ...
        For Each tr As TableRow In tb_type_menu.Rows
            ...
            If f.HasFile Then
                ...
                If exten.ToUpper = "PDF" Then
                    ...
                    Dim paths As String = bao._PATH_XML_PDF_TABEAN_DONATE
