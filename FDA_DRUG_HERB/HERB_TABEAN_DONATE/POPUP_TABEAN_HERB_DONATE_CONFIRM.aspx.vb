...
Public Class POPUP_TABEAN_HERB_DONATE_CONFIRM
    ...
    Sub alert_summit(ByVal text As String, ByVal ida As Integer)
        Dim url As String = ""
        url = "POPUP_TABEAN_HERB_DONATE_UPLOAD.aspx?IDA=" & ida & "&PROCESS_ID=" & _Process_ID & "&IDA_LCN=" & _IDA_LCN & "&IDA_DR=" & _IDA_DR
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.Target = "_blank"
            H.NavigateUrl = "FRM_TABEAN_HERB_DONATE_PREVIEWaspx.aspx?ida=" & IDA
