<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_Product.Master" CodeBehind="FRM_TABEAN_HERB_DONATE.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_TABEAN_HERB_DONATE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12" style="text-align: center">
            <h3>แบบแจ้งขออนุญาตผลิตหรือนำเข้าผลิตภัณฑ์สมุนไพรเพื่อบริจาค</h3>
        </div>
    </div>

    <div class="row">
        <div class="col-lg-12" style="text-align: right;padding-left:2em;padding-right:2em"">
            <asp:Button ID="btn_add_tabean" runat="server" Text="เพิ่มคำขอผลิตภัณฑ์สมุนไพรเพื่อบริจาค" Height="40px" Width="324px" />
