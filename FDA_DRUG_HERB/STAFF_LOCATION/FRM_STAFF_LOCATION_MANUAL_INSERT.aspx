<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_STAFF_LOCATION_MANUAL_INSERT.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_LOCATION_MANUAL_INSERT" EnableEventValidation="false" %>
        ...
        <table style="width:100%">
            <tr>
                <td style="width:30%  ; padding-left:15%; text-align:left" colspan="2">
                    ...
                    <h2><asp:Label ID="Label21" runat="server" Text="ชื่อสถานที่"></asp:Label></h2>
             ...
             <tr>
              ...
              <tr>
                <td style="width:30% ; padding-left:15%; text-align:left" colspan="2">
                    ...
                    <h2><asp:Label ID="Label24" runat="server" Text="ที่ตั้งสถานที่"></asp:Label></h2>
              ...
              <tr>
                ...
                <asp:TextBox ID="txt_thacode_id_lo"  runat="server" Width="70%" ></asp:TextBox>
                    ...
                    (หมายเหตุ สามารถดึงได้ทีละเลข)</td>
            </tr>
              <tr>
                <td style="width:30%  ; text-align:right" colspan="2">
              ...
              <tr>
               ...
               <tr>
                ...
                <asp:TextBox ID="txt_latitude" runat="server"  Width="70%" ></asp:TextBox>
                    ...
                    &nbsp;(อยู่ในช่วงระหว่าง 5.6166667 - 20.4666667)</td>
            </tr>
               <tr>
                <td style="width:30%  ; text-align:right" colspan="2">
                ...
                <asp:TextBox ID="txt_longitude" runat="server"  Width="70%" ></asp:TextBox>
                    ...
                    (อยู่ในช่วงระหว่าง 97.3500000 - 105.6166667)</td>
            </tr>
