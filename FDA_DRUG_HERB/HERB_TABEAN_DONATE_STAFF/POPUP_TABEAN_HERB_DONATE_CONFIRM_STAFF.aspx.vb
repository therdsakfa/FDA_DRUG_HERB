...
Public Class POPUP_TABEAN_HERB_DONATE_CONFIRM_STAFF
    ...
    Sub Bind_PDF()
        ...
        Dim XML As New CLASS_GEN_XML.TABEAN_DONATE
        TBN_DONATE = XML.Gen_XML_DONATE(_IDA, _IDA_LCN)

        Dim dao_pdftemplate As New DAO_DRUG.ClsDB_MAS_TEMPLATE_PROCESS
        dao_pdftemplate.GETDATA_TABEAN_HERB_JJ_TEMPLAETE1(_Process_ID, dao.fields.STATUS_ID, "บจ1", 0)

        Dim _PATH_FILE As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_DONATE") 'path
    ...
    Public Sub bind_dd()
        ...
        Dim dao_sub As New DAO_TABEAN_HERB.TB_TABEAN_DONATE
        ...
        dt = Get_DDL_DATA(211, int_group_ddl1, int_group_ddl2)
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.Target = "_blank"
            H.NavigateUrl = "../HERB_TABEAN_DONATE_STAFF/FRM_TABEAN_HERB_DONATE_STAFF_PREVIEWaspx.aspx?ida=" & IDA
