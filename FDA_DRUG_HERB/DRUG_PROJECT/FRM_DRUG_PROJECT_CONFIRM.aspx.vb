...
Public Class FRM_DRUG_PROJECT_CONFIRM
    ...
    Function run_rcvno() As Integer
        ...
        bao.FAGenID("RCVNO", "DRUG_PROJECT")
 ...
 Sub alert(ByVal text As String)
    ...
    Private Sub BindData_PDF()
        ...
        Dim cls_CER As New CLASS_GEN_XML.DRUG_PROJECT(_CLS.CITIZEN_ID, _CLS.LCNSID_CUSTOMER, dao_lcn.fields.lcnno, dao_lcn.fields.lcntpcd, dao_lcn.fields.pvncd, dao_lcn.fields.IDA)
