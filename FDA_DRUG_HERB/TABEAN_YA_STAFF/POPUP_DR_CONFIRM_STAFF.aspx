<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_DR_CONFIRM_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_DR_CONFIRM_STAFF" %>
...
<%--                     <tr><td>
                     ...
                     <tr><td>  <asp:Button ID="btn_preview" runat="server" Text="Preview ใบสำคัญ" CssClass="btn-lg"   Width="80%" /></td></tr>
