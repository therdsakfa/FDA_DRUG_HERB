...
Public Class FRM_REGIST_SEARCH
    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            ElseIf e.CommandName = "add" Then
                ...
                '    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('../TABEAN_YA/FRM_RQT_REGIST_INFORMATION_V2.aspx?IDA=" & IDA & "&STATUS_ID=" & STATUS_ID & "&NEWCODE=" & item("Newcode_U").Text & "&e=1" & "&type=rg'); ", True)
                'Else
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('../TABEAN_YA/FRM_RQT_REGIST_INFORMATION.aspx?IDA=" & IDA & "&STATUS_ID=" & STATUS_ID & "&NEWCODE=" & item("Newcode_U").Text & "&type=rg'); ", True)
                'End If
            ...
            ElseIf e.CommandName = "report" Then
                ...
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "../TABEAN_YA_STAFF/FRM_REPORT_TABEAN.aspx?IDA=" & IDA & "&TR_ID=" & tr_id & "&STATUS_ID=" & STATUS_ID & "&status=" & STATUS_ID & "');", True)
    ...
    Private Sub RadGrid1_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        ' bao.SP_DRRGT_FOR_SEARCH_NEW(txt_lcnno_no.Text)
