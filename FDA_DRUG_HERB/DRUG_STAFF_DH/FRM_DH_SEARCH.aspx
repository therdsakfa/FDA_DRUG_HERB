<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_DH_SEARCH.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DH_SEARCH" %>
    ...
    <div>
        ...
        <table style="width: 100%;" class=" table">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddl_status" runat="server" class="form-control" DataSourceID="SqlDataSource1" DataTextField="STATUS_NAME" DataValueField="STATUS_ID"></asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LGT_DRUGConnectionString %>" SelectCommand="SELECT [STATUS_ID], [STATUS_NAME] FROM [MAS_STATUS] WHERE (([STATUS_GROUP] = @STATUS_GROUP) AND ([STATUS_ID] &gt;= @STATUS_ID)) ORDER BY [SEQ]">
                        <SelectParameters>
            ...
            <tr>
                <td>เลข DRM</td>
                <td>
                    <asp:TextBox ID="txt_drm" class="form-control" runat="server"></asp:TextBox>
                </td>

                <td>
                    ชื่อสาร</td>
                <td style="width:25%;">
                    <asp:TextBox ID="txt_chem" class="form-control" runat="server"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
       ...
       <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="15">
           <MasterTableView>
               <Columns>
                   ...
                   <telerik:GridBoundColumn DataField="phm15dgt" UniqueName="phm15dgt" HeaderText="เลข DRM" >
                   </telerik:GridBoundColumn>
                   <telerik:GridBoundColumn DataField="CAS_NAME" UniqueName="CAS_NAME" HeaderText="ชื่อสาร" >
                   </telerik:GridBoundColumn>
