<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_CER_FOREIGN_UPLOAD.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_CER_FOREIGN_UPLOAD" %>
     ...
     <div style="width:100% ; text-align:left"  >
         ...
         <table class="table"> <tr><td style="width:15%;">   ใบคำขอ</td><td>   <asp:FileUpload ID="FileUpload1" runat="server" CssClass="btn-default" />  </td></tr>
             <tr><td colspan="2"> 
                 ...
                 <uc1:UC_ATTACH_DRUG runat="server" ID="UC_ATTACH_DRUG_0" />
                 </td></tr>
             <tr><td colspan="2">
                 <uc1:UC_ATTACH_DRUG runat="server" ID="UC_ATTACH_DRUG_1" />
                 </td></tr>
             <tr><td colspan="2">
                    <table class="table" style="width:100%;">
                        <tr><td style="width:30%;">   เบอร์โทรศัพท์เพื่อติดต่อกลับ</td><td>   
                 <asp:TextBox ID="txt_Mobile" runat="server"></asp:TextBox>
                 </td></tr>
                        <tr><td style="width:30%;">   เลขดำเนินการเก่า (กรณีคืนคำขอ)</td><td>   
                            <asp:TextBox ID="txt_OLD_TR_ID" runat="server"></asp:TextBox>
                 </td></tr>
                    </table>
                 </td></tr>
