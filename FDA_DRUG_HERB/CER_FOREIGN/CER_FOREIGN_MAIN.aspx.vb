...
Public Class CER_FOREIGN_MAIN
    ...
    Private Sub convert_Database_To_XML(ByVal path As String)
        ...
        'Dim cls_CER As New CLASS_GEN_XML.Cerf(_CLS.CITIZEN_ID, _CLS.LCNSID_CUSTOMER, 1, dao_lcn.fields.IDA)
        Dim cls_CER As New CLASS_GEN_XML.Cerf(_CLS.CITIZEN_ID, _CLS.LCNSID_CUSTOMER, 1, dao_lcn.fields.IDA, 1)
        Dim cls_xml As New CLASS_CER_FOREIGN
        cls_xml = cls_CER.gen_xml_CER()
        cls_xml.CER_FOREIGNs.CER_TYPE = _process
        ...
        cls_xml.BSN_THAIFULLNAME = dao_lcn.fields.BSN_THAIFULLNAME
    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "sel" Then
                ...
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_CER_FOREIGN_CONFIRM.aspx?IDA=" & IDA & "&FK_IDA=" & IDA & "&TR_ID=" & tr_id & "&ProcessID=" & _process & "');", True)
            End If
    ...
    Private Sub RadGrid1_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        If Request.QueryString("identify") <> "" Then
            Try
                bao.SP_CUSTOMER_CER_FOREIGN_BY_FK_IDA_and_CER_TYPE_and_iden(_lcn_ida, _process, Request.QueryString("identify"))
            Catch ex As Exception

            End Try
        Else
            Try
                bao.SP_CUSTOMER_CER_FOREIGN_BY_FK_IDA_and_CER_TYPE(_lcn_ida, _process)  'นำข้อมูลมโชในจาก SP มาไว้ที่ DataTable
            Catch ex As Exception
