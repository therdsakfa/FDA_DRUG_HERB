<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NODE.Master" CodeBehind="FRM_NORYORMOR_2_to_5_DETAIL.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_NORYORMOR_2_to_5_MAIN" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ContentPlaceHolder1_btn_upload').click(function () {
                ...
                //  $('#spinner').toggle('slow');
                Popups('POPUP_NORYORMOR_2_to_5_UPLOAD.aspx?process=' + process_id + '&fk_ida=' + IDA);
                return false;
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <img src="../imgs/spinner.gif" alt="Loading" style="position: absolute; top: 120px; left: 293px; height: 185px; width: 207px;" />
    ...
    <fieldset>
           <legend style="color: red;"><h2>ข้อมูล</h2>
   ...
   <div>
           ...
           <legend style="color: red;">
               <asp:Label ID="lb_nym" runat="server"></asp:Label>
           ...
           <table style="width: 100%;">
               <tr>
                   <td>
                     ...
                     <ItemTemplate>
                        <%--<asp:Button ID="btn_sel" runat="server" Text="เลือกข้อมูล" CommandName="lnk_to" Width="100%" CssClass="btn-link"   CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'  />--%>
     ...
     <fieldset>
           <legend style="color: red;"><h2>ข้อมูลจากระบบด่าน</h2></legend>
           <table class="table" style="width:100%;">
   <tr>
        <td>
