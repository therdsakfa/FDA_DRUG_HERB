<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCT_ID.Master" CodeBehind="FRM_DRUG_FOR_RESEARCH.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DRUG_FOR_RESEARCH" %>
 ...
 <table>
    ...
    <div class="panel-info" style="text-align: right; width: 100%">
        <div style="text-align: right; padding-left: 5%; height: 60px;">
            <asp:Button ID="btn_add" runat="server" Text="เพิ่มผลิตภัณฑ์ยา" Width="170px" CssClass="btn-lg " />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           ...
           <MasterTableView AutoGenerateColumns="False">
               <Columns>
                   ...
                   <telerik:GridBoundColumn DataField="CREATE_DATE" FilterControlAltText="Filter CREATE_DATE column"
                       ...
                       HeaderText="เลขทะเบียน" SortExpression="RCVNO_DISPLAY" UniqueName="RCVNO_DISPLAY">
                   </telerik:GridBoundColumn>
