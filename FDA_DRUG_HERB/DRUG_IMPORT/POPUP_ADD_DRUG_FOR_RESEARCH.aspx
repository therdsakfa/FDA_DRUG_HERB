<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_ADD_DRUG_FOR_RESEARCH.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_ADD_DRUG_FOR_RESEARCH" %>
...
&nbsp;
             ...
             <tr><td class="auto-style1">   ตัวยาสำคัญ</td><td>   
                ชื่อสาร :&nbsp;
                 <asp:TextBox ID="txt_casname" runat="server"></asp:TextBox>
&nbsp;
                 <asp:Button ID="Button2" runat="server" Text="ค้นหา" />
                 <asp:Label ID="lbl_activenm" runat="server" Visible="False"></asp:Label>
                 <asp:Label ID="lbl_activecd" runat="server" Visible="False"></asp:Label>
                 <br />
                 ...
                 &nbsp;ปริมาณต่อหน่วย&nbsp;
                 <asp:TextBox ID="txt_dosage" runat="server" Width="80px"></asp:TextBox>
&nbsp;
                 <asp:DropDownList ID="ddl_unit" runat="server">
                 </asp:DropDownList>
&nbsp;
                 <asp:Button ID="btn_save_active" runat="server" Text="เพิ่ม" />
                 <asp:Label ID="lbl_dosage" runat="server" Visible="False"></asp:Label>
                 <asp:Label ID="lbl_unitcd" runat="server" Visible="False"></asp:Label>
                 <asp:Label ID="lbl_unitnm" runat="server" Visible="False"></asp:Label>
                 </tr>
