<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POP_UP_LCN_RENEW_CHECK.aspx.vb" Inherits="FDA_DRUG_HERB.POP_UP_LCN_RENEW_CHECK" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12" style="text-align: center;">
            ...
            <h1>ระบบตรวจสอบข้อมูลสถานประกอบการผลิตภัณฑ์สมุนไพร</h1>
        </div>
    </div>
    ...
    <footer>
        <div class="row" id="E1" runat="server">
            <div class="col-lg-12" style="text-align: center">
                <asp:Button ID="btn_save" runat="server" Text="ตรวจสอบข้อมูลส่วนที่ 1 แล้วถูกต้อง" Height="40px" Width="234px" CssClass="auto-style1" />&ensp;
                <asp:Button ID="btn_save2" runat="server" Text="ตรวจสอบข้อมูลส่วนที่ 1 แล้วไม่ถูกต้อง" Height="40px" Width="251px" />
            </div>
        </div>
    </footer>
</asp:Content>
