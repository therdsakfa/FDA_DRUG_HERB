<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_LCN_SUBSTITUTE_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_SUBSTITUTE_MAIN" %>
    ...
    <div class="h3" style="padding-left:5%;">  <asp:Label ID="lbl_name" runat="server" Visible="false" Text=""></asp:Label> </div>
     ...
     <div class="panel" style="text-align:left ;width:100%">
         <div  style="height:60px" > 
             ...
             <div  class="col-lg-4 col-md-4"><h3> คำขอใบแทน</h3></div>
                                           ...
                                           <td align="right">
                                               <table>
                                                   <tr>
                                                       ...
                                                       <td>
                                                           <asp:Button ID="btn_upload" runat="server" Text="คำขอฬหม่" CssClass="btn-lg" />
                                                       </td>
                                                   </tr>
                                               </table>
                                           </td>
