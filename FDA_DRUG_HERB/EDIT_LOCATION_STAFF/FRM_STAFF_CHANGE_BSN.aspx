<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_CHANGE_BSN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_CHANGE_BSN" %>
               ...
               <MasterTableView AutoGenerateColumns="False">
                   <Columns>
                       ...
                       <telerik:GridBoundColumn DataField="REMARK" FilterControlAltText="Filter REMARK column"
                           HeaderText="รายละเอียด" SortExpression="REMARK" UniqueName="REMARK">
                       </telerik:GridBoundColumn>
