<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_STAFF_EDIT_LOCATION_CONFIRM_V2.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_STAFF_EDIT_LOCATION_CONFIRM_V2" %>
            ...
            <td rowspan="2" style="width:70%;">
                ...
                <div >
                     <table class="table" style="width:100%">
                         ...
                         <tr>
                             <td align="right">ขอเปลี่ยนแปลงรายการในใบอนุญาต ดังต่อไปนี้</td>
                             <td>
                                 <asp:TextBox ID="txt_REMARK" runat="server" CssClass="input-sm" Height="100px" TextMode="MultiLine" Width="400px" Enabled="false"></asp:TextBox>
                             </td>
                         </tr>
                     </table>
    </div>
