<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_EXTEND_TIME_LOCATION_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_EXTEND_TIME_LOCATION_MAIN" %>
            ...
            <div style="text-align: center;">
               ...
               <MasterTableView AutoGenerateColumns="False">
                   <Columns>
                       ...
                       <telerik:GridBoundColumn DataField="YEAR_EXTEXD" FilterControlAltText="Filter YEAR_EXTEXD column"
                           HeaderText="เพื่อใช้ในปี" SortExpression="YEAR_EXTEXD" UniqueName="YEAR_EXTEXD">
                       </telerik:GridBoundColumn>
                       <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_Select"
                           CommandName="sel" Text="ดูข้อมูล">
                           <HeaderStyle Width="70px" />
                       </telerik:GridButtonColumn>
                       <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_view"
                           CommandName="view" Text="ดูใบอนุญาต">
                           <HeaderStyle Width="70px" />
                       </telerik:GridButtonColumn>
                  </Columns>
               </MasterTableView>
                ...
                <%--<asp:GridView ID="GV_data" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="table" DataKeyNames="IDA" ForeColor="#333333" GridLines="None" Width="100%">
