<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_EDIT.Master" CodeBehind="FRM_LCN_CANCEL.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_CANCEL" %>
                   ...
                   <td>
                       <asp:GridView ID="GV_data" DataKeyNames="IDA" runat="server" Width="100%" CssClass="table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                           ...
                           <Columns>
                               ...
                               <asp:BoundField DataField="LCNNO_DISPLAY" HeaderText="เลขใบอนุญาต" ItemStyle-Width="10%">
                                   <ItemStyle Width="20%"></ItemStyle>
                               </asp:BoundField>
                               <asp:BoundField DataField="app_date" DataFormatString="{0:d}" HeaderText="วันที่อนุญาต" ItemStyle-Width="20%">
                                   <ItemStyle Width="20%"></ItemStyle>
                               </asp:BoundField>
                               <asp:BoundField DataField="STATUS_NAME" HeaderText="สถานะ" ItemStyle-Width="20%">
                                  
                               </asp:BoundField>
                              <asp:BoundField DataField="cnccsnm" HeaderText="เหตุผลการยกเลิก" ItemStyle-Width="30%">
