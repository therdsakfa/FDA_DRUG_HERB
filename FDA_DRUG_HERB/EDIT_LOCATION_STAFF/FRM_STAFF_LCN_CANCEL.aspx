<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_LCN_CANCEL.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_LCN_CANCEL" %>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="true" PageSize="15">
               <MasterTableView AutoGenerateColumns="False">
                   <Columns>
                       ...
                       <telerik:GridBoundColumn DataField="cnccsnm" FilterControlAltText="Filter cnccsnm column"
                           HeaderText="เหตุผลการยกเลิก" SortExpression="cnccsnm" UniqueName="cnccsnm">
                       </telerik:GridBoundColumn>
