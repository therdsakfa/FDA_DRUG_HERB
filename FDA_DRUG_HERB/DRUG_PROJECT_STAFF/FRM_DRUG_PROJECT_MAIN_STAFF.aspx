<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NODE.Master" CodeBehind="FRM_DRUG_PROJECT_MAIN_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_DRUG_PROJECT_MAIN_STAFF" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function () {
            ...
            $('#ContentPlaceHolder1_btn_upload').click(function () {
                ...
                //  $('#spinner').toggle('slow');
                Popups('FRM_DRUG_PROJECT_UPLOAD.aspx');
                return false;
            });
    ...
    <AlternatingRowStyle BackColor="White" />
        <Columns>
           ...
           <%-- <asp:TemplateField ItemStyle-Width="0%">
            ...
            <asp:BoundField DataField="TH_NAME" HeaderText="ชื่อโครงการ" ItemStyle-Width="10%">
            ...
            <asp:TemplateField ItemStyle-Width="20%">
             ...
             <asp:TemplateField ItemStyle-Width="10%">
                   ...
                   <%--<asp:Button ID="btn_Select" runat="server" Text="ดูข้อมูล" CommandName="sel" Width="0%" Visible CssClass="btn-link"  CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'  />  &nbsp; &nbsp; &nbsp;--%>
                         <asp:Button ID="btn_lcn" runat="server" Text="เลือกข้อมูล" CommandName="nym" Width="100%" CssClass="btn-link"   CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'  />
