...
Public Class FRM_DRUG_PROJECT_CONFIRM_STAFF
    ...
    Protected Sub btn_cancel_Click(sender As Object, e As EventArgs) Handles btn_cancel.Click
        ...
        Response.Write("window.location.href = 'FRM_DRUG_PROJECT_MAIN_STAFF.aspx';")
    ...
    Private Sub BindData_PDF()
        ...
        Dim dao_dh15rqt As New DAO_DRUG.ClsDBdh15rqt
        dao_dh15rqt.GetDataby_IDA(_IDA)
        Dim dao As New DAO_DRUG.ClsDBdalcn
        dao.GetDataby_IDA(dao.fields.FK_IDA)

        Dim cls_regis As New CLASS_GEN_XML.DH(_CLS.CITIZEN_ID, dao.fields.lcnsid, dao.fields.lcnno, dao.fields.lcntpcd, dao.fields.pvncd, dao.fields.FK_IDA)
        ...
        Try
            ...
            class_xml.dh15rqts = dao_dh15rqt.fields
        Catch ex As Exception
