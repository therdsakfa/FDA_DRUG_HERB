...
Public Class FRM_HERB_TABEAN_STAFF_TABEAN_EDIT2
    ...
    Public Sub BindTable()
        ...
        If _TR_ID <> 0 Then
            ...
            dao_up.GetdatabyID_IDA_TYPE(_IDA, 11)
    ...
    Private Function check_file()
        ...
        dao_check.GetdatabyID_TR_ID_PROCESS_ID_ALL(_TR_ID, _ProcessID, 11)
