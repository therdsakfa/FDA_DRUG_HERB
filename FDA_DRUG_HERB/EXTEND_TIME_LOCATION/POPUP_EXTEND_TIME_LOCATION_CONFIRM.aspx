<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_EXTEND_TIME_LOCATION_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_EXTEND_TIME_LOCATION_CONFIRM" %>
...
<%@ Register Src="~/EXTEND_TIME_LOCATION/UC_EXTEND_TIME_CHECK.ascx" TagPrefix="uc1" TagName="UC_EXTEND_TIME_CHECK" %>
...
<%--                 <asp:Panel ID="Panel1" runat="server" style="display:none;" >  
                   <strong>
                    ...
                    <br />
                     <strong>
                     <asp:CheckBox ID="chk1" runat="server"  Text="ขายปลีก" />
                     </strong>
                     <br />
