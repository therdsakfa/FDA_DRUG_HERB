...
Public Class POPUP_HERB_TABEAN_INFORM_STAFF_EDIT
    ...
    Sub Blind_PDF()
        ...
        dao_pdftemplate.GETDATA_TABEAN_HERB_JJ_TEMPLAETE1(_ProcessID, dao.fields.STATUS_ID, "จร1", 0)
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        If UC_ATTACH.CHK_TBN = False Then
        ...
        Else
            ...
            'UC_ATTACH_LCN.ATTACH(dao.fields.TR_ID, dao.fields.FK_LCN, dao.fields.PROCESS_ID, Year, "3", path)
            UC_ATTACH.insert_TBN_JR(_TR_ID, dao.fields.PROCESS_ID, dao.fields.IDA, 77)
