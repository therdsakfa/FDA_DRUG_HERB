<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_HERB_TABEAN_INFORM_STAFF_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_HERB_TABEAN_INFORM_STAFF_EDIT" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="~/UC/UC_ATTACH.ascx" TagPrefix="uc1" TagName="UC_ATTACH" %>
    ...
    <div class="row">
        <div style="text-align: center">
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="col-lg-8">
                        <uc1:UC_ATTACH runat="server" id="UC_ATTACH" />
                    </div>
