<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_HERB_TABEAN_INFORM_CONFIRM_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_HERB_TABEAN_INFORM_CONFIRM_STAFF" %>
        ...
        <div class="col-lg-4" style="width: 30%">
            <div class="row" runat="server" id="KEEP_PAY" visible="true">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <telerik:RadComboBox ID="DD_STATUS" runat="server" Filter="Contains" Width="100%" AutoPostBack="true"></telerik:RadComboBox>
                ...
                <div class="row" runat="server" id="P12" visible="true">
                    ...
                    <panel id="Panel1" runat="server" style="display: none;">
                        <div class="row">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-4">
                    ...
                    <div class="row" runat="server">
                        ...
                        <div class="col-lg-6">
                            ...
                            <telerik:RadDatePicker ID="submit_date" runat="server" Width="100%" RenderMode="Lightweight">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" RenderMode="Lightweight"></Calendar>

<DateInput DisplayDateFormat="d/M/yyyy" DateFormat="d/M/yyyy" LabelWidth="40%">
