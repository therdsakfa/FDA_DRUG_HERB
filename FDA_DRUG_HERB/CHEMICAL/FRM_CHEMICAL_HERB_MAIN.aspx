<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCT_PHESAJ.Master" CodeBehind="FRM_CHEMICAL_HERB_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_CHEMICAL_HERB_MAIN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <script type="text/javascript" >
           $(document).ready(function () {
               ...
               $('#ContentPlaceHolder1_btn_add').click(function () {
                   ...
                   Popups('POPUP_HERB_INSERT_AND_UPDATE.aspx?g=' + g + '&mt=' + mt + '&process=' + process);
                   return false;
               });
    ...
    <div id="spinner" style="background-color: transparent;display:none;">
        ...
        <div class="panel-heading panel-title" style="padding-left: 5%;">
         <h2>
             <asp:Label ID="lbl_name_page" runat="server" Text ="เพิ่มสารสมุนไพร"></asp:Label>
         </h2>
        </div>
