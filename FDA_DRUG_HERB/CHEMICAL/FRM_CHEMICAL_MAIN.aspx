<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCT_PHESAJ.Master" CodeBehind="FRM_CHEMICAL_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_CHEMICAL_MAIN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <script type="text/javascript" >
           $(document).ready(function () {
               ...
               $('#ContentPlaceHolder1_btn_add').click(function () {
                   ...
                   Popups('FRM_CHEMICAL_MAIN_INSERT_AND_UPDATE.aspx?lcn_ida=' + IDA + '&mt=' + mt + '&st=' + st + '&t=' + t + '&process=' + process);
                   return false;
               });
   ...
   <div>
       ...
       <asp:BoundField DataField="rcvno" HeaderText="เลขรับ" ItemStyle-Width="20%">
               ...
               <asp:TemplateField ItemStyle-Width="20%" >
                   <ItemTemplate>
                       <asp:Button ID="btn_remark" runat="server" Text="หมายเหตุ" CommandName="_remark" Width="100%" CssClass="btn-link" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' />
                   </ItemTemplate>
                   <ItemStyle Width="20%"></ItemStyle>
               </asp:TemplateField>
           </Columns>
