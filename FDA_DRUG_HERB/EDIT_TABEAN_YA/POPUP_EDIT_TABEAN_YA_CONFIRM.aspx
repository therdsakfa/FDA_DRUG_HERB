<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_EDIT_TABEAN_YA_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.WebForm14" %>
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <table class="table" style="width:90%"> 
                     ...
                     <tr><td><asp:Button ID="btn_confirm" runat="server" Text="ยื่นคำขอ" CssClass="btn-lg" OnClientClick="return confirm('แน่ใจมั้ย');"   Width="80%" /></td></tr>
