<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_REGISTRATION_CONFIRM_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_REGISTRATION_CONFIRM_STAFF" %>
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;" valign="top">
                 ...
                 <table class="table" style="width:90%"> 
                     <tr><td>
                         <asp:DropDownList ID="ddl_cnsdcd" runat="server" Width="80%">
                         </asp:DropDownList>
                         </td></tr>
                     <tr><td>
                         วันที่
