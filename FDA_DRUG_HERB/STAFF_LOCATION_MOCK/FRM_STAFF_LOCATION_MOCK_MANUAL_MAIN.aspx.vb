...
Public Class FRM_STAFF_LOCATION_MOCK_MANUAL_MAIN
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.NavigateUrl = "FRM_STAFF_LCN_MOCK.aspx?lct_ida=" & IDA & "&process=122" & "&identify=" & _CLS.CITIZEN_ID_AUTHORIZE
    ...
    Private Sub rg_name_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles rg_name.ItemCommand
        ...
        If e.CommandName = "sel" Then
            ...
            Session("CLS") = _CLS
            Dim dt As New DataTable
            dt = bao.SP_CUSTOMER_LOCATION_ADDRESS_MOCK_by_LOCATION_TYPE_ID_and_IDEN(1, _CLS.CITIZEN_ID_AUTHORIZE)
            ...
            dt2 = bao.SP_CUSTOMER_LOCATION_ADDRESS_MOCK_by_LOCATION_TYPE_ID_and_IDEN_V2(2, _CLS.CITIZEN_ID_AUTHORIZE)
            RadGrid2.DataSource = dt2
            RadGrid2.Rebind()
        End If
    End Sub
    Private Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        Dim url As String = "../STAFF_LOCATION_MOCK/FRM_STAFF_LOCATION_MOCK_MANUAL_INSERT.aspx?iden=" & _CLS.CITIZEN_ID_AUTHORIZE
