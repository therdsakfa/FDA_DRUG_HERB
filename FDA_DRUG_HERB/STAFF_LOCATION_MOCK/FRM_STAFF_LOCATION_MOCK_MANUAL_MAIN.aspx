<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_LOCATION_MOCK_MANUAL_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_LOCATION_MOCK_MANUAL_MAIN" %>
    ...
    <div class="panel" style="text-align: left; width: 100%">
        <div class="panel-heading panel-title" style="height: 70px">
            ...
            <div class="col-lg-4 col-md-4">
                <h4>เพิ่มสถานที่ตั้ง/ที่เก็บ(จำลอง)</h4>
            </div>
