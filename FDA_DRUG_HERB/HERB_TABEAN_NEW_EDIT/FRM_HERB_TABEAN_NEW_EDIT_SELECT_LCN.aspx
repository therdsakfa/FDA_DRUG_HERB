<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_PPK.Master" CodeBehind="FRM_HERB_TABEAN_NEW_EDIT_SELECT_LCN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_NEW_EDIT_SELECT_LCN" %>
  ...
  <div class="row" id="T1" runat="server" visible="false">
        <div class="panel" style="text-align: left; width: 100%">
            <div class="panel-heading panel-title" style="height: 70px">
                <p class="h3" style="text-align: left;">คำขอแก้ไขเปลี่ยนแปลงรายการในใบสำคัญการขึ้นทะเบียนตำรับผลิตภัณฑ์สมุนไพร</p>
            </div>
        </div>
