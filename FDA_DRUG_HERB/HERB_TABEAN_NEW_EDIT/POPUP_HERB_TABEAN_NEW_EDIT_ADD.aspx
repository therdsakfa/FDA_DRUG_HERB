<%@ Page Title="" Language="vb" MaintainScrollPositionOnPostback="true"  AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_HERB_TABEAN_NEW_EDIT_ADD.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_HERB_TABEAN_NEW_EDIT_ADD" %>

<%@ Register Src="~/HERB_TABEAN_NEW_EDIT/UC/UC_TABEAN_EDIT.ascx" TagPrefix="uc1" TagName="UC_TABEAN_EDIT" %>
<%@ Register Src="~/HERB_TABEAN_NEW_EDIT/UC/UC_TABEAN_EDIT_DETAIL.ascx" TagPrefix="uc1" TagName="UC_TABEAN_EDIT_DETAIL" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <asp:Panel ID="Panel1" runat="server" Style="display: none;">
                <uc1:UC_TABEAN_EDIT runat="server" id="UC_TABEAN_EDIT" />
            </asp:Panel>
          <%--  <asp:Panel ID="Panel2" runat="server" Style="display: none;">
                <uc1:UC_TABEAN_EDIT_SELECT_LIST runat="server" id="UC_TABEAN_EDIT_SELECT_LIST" />
            </asp:Panel>
            <asp:Panel ID="Panel3" runat="server" Style="display: none;">
                <uc1:UC_TABEAN_EDIT_DETAIL runat="server" id="UC_TABEAN_EDIT_DETAIL" />
            </asp:Panel>--%>
        </div>
        <div class="col-lg-1"></div>
    </div>
