...
Public Class POPUP_HERB_TABEAN_NEW_EDIT_CONFIRM
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        ...
        Response.Redirect("POPUP_HERB_TABEAN_NEW_EDIT_CONFIRM_DETAIL.aspx?IDA=" & _IDA& & "&PROCESS_ID=" & _Process_ID)
    End Sub
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.Target = "_blank"
            H.NavigateUrl = "FRM_HERB_TABEAN_NEW_EDIT_PREVIEW.aspx?ida=" & IDA
