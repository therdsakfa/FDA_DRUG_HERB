...
Public Class UC_TABEAN_EDIT_DETAIL_CAS
    Inherits System.Web.UI.UserControl

    Dim _IDA As String
    Dim _IDA_DR As String
    ...
    Private Sub rg_chem_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles rg_chem.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            Dim IDA_CAS As Integer = 0
            Try
                IDA = item("IDA").Text
                IDA_CAS = item("FK_DETAIL_CAS").Text
            Catch ex As Exception
            ...
            If e.CommandName = "_del" Then
                ...
                Else
                    ...
                    dao = New DAO_TABEAN_HERB.TB_TABEAN_EDIT_DETAIL_CAS
                    dao.GetDataby_FK_IDA_ORDER(_IDA, FK_SET)
                    Dim i As Integer = 1
                    For Each dao.fields In dao.datas
                        Dim dao_up As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_DETAIL_CAS
            ...
            ElseIf e.CommandName = "_eqto" Then
                Dim url As String = "../HERB_TABEAN_NEW_EDIT/FRM_HERB_NEW_TABEAN_EDIT_EQTO.aspx?IDA_EQ=" & IDA_CAS & "&type=" & Request.QueryString("type") & "&tr_id=" & Request.QueryString("tr_id") & "&idr=" & _IDA & "&STATUS_ID=" & STATUS_ID & "&fk_set=" & item("FK_SET").Text _
                & "&process_id=" & _Process_ID & "&IDA_LCN=" & _IDA_LCN & "&IDA_DR=" & _IDA_DR & "&IDA=" & _IDA
    ...
    Private Sub rg_chem_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles rg_chem.NeedDataSource
        ...
        dt = bao.SP_TABEAN_EDIT_DETAIL_CAS_BY_FK_IDA(_IDA, ddl_set.SelectedValue)
    ...
    Protected Sub btn_select_Click(sender As Object, e As EventArgs) Handles btn_select.Click
        ...
        For Each item As GridDataItem In rg_search_iowa.SelectedItems
            ...
            End Try
            Dim dao_max As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_DETAIL_CAS
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        Dim dao_count As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_EACH
        Dim i As Integer = 0
        i = dao_count.CountDataby_FK_IDA(Request.QueryString("IDA"))
        If i = 0 Then
            Dim dao As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_EACH
    ...
    Private Sub btn_up_Click(sender As Object, e As EventArgs) Handles btn_up.Click
        ...
        For Each item As GridDataItem In rg_chem.SelectedItems
            Dim dao_curr As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_DETAIL_CAS
            Dim dao_max As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_DETAIL_CAS
            Dim dao_min As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_DETAIL_CAS
            Dim dao_rowup As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_DETAIL_CAS
