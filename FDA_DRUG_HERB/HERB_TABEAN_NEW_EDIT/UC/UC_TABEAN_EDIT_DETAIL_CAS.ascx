<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_TABEAN_EDIT_DETAIL_CAS.ascx.vb" Inherits="FDA_DRUG_HERB.UC_TABEAN_EDIT_DETAIL_CAS" %>
            ...
            <telerik:RadGrid ID="rg_chem" runat="server" Width="100%">
                <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA" NoMasterRecordsText="ไม่พบข้อมูล">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="FK_DETAIL_CAS" DataType="System.Int32" FilterControlAltText="Filter FK_DETAIL_CAS column" HeaderText="FK_DETAIL_CAS"
                            SortExpression="FK_DETAIL_CAS" UniqueName="FK_DETAIL_CAS" Display="false">
                        </telerik:GridBoundColumn>
