...
Imports System.IO
    ...
    Public Class UC_TABEAN_EDIT_EQTO
        Inherits System.Web.UI.UserControl
        Dim _IDA As String
        Dim STATUS_ID As Integer = 0
    Private _CLS As New CLS_SESSION
    Private _IDA_DR As String = ""
    Private _IDA_EQ As String = ""
    Private _IDA_LCN As String = ""
    Private _Process_ID As String = ""
    Sub RunQuery()
        _IDA = Request.QueryString("IDA")
        _IDA_EQ = Request.QueryString("IDA_EQ")
        ...
        Protected Sub btn_select_Click(sender As Object, e As EventArgs) Handles btn_select.Click
            ...
            Dim old_data As String = ""
                ...
                Dim dao_max As New DAO_TABEAN_HERB.TB_TABEAN_HERB_EDIT_EQTO
                    ...
                    dao.fields.FK_DRRQT_IDA = Request.QueryString("IDA_DR")
                    ...
                    '    dao_rg2.GetDataby_IDA(Request.QueryString("IDA_DR"))
                    '    'dao_rg2.GetDataby_IDA(_IDA)
                    ...
                    '            dao_esub_xml.GetDataby_IDA_drrgt(Request.QueryString("IDA_DR"))
                    '            'dao_esub_xml.GetDataby_IDA_drrgt(_IDA)
                    ...
                    '                dao1.GetDataby_IDA(Request.QueryString("IDA_DR"))
                ...
                Dim dao_dr As New DAO_TABEAN_HERB.TB_TABEAN_HERB_EDIT_EQTO
    ...
    Private Sub rg_chem_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles rg_chem.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            '        Dim dao_rg As New DAO_DRUG.ClsDBdrrgt
            '        dao_rg.GetDataby_IDA(Request.QueryString("IDA_DR"))
            ...
            'KEEP_LOGS_TABEAN_BC(dao_rg.fields.pvncd, dao_rg2.fields.rgttpcd, dao_rg2.fields.drgtpcd, dao_rg2.fields.rgtno, dao_rg2.fields.IDA,
            '                    dao_rg2.fields.IDENTIFY, new_data, "", old_data, result, url, _CLS.CITIZEN_ID)
    ...
    Private Sub rg_chem_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles rg_chem.NeedDataSource
        ...
        'If STATUS_ID = 8 Then
        '    Dim dao1 As New DAO_DRUG.ClsDBdrrgt
        '    dao1.GetDataby_IDA(_IDA_DR)
        'Dim dao2 As New DAO_DRUG.TB_DRRGT_DETAIL_CAS
        'dao2.GetDataby_FKIDA(dao1.fields.IDA)
        'dt = bao.SP_DRRGT_EQTO_BY_FK_IDA(_IDA_DR)
        dt = bao.SP_TABEAN_EDIT_EQTO_BY_FK_IDA(_IDA_EQ)
        'Else
        '    dt = bao.SP_DRRQT_EQTO_BY_FK_IDA(_IDA_DR)
        'End If

        rg_chem.DataSource = dt
    End Sub
    Private Sub rg_chem_OLD_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles rg_chem_OLD.NeedDataSource
        Dim bao As New BAO_SHOW
        Dim dt As New DataTable
        'If STATUS_ID = 8 Then
        '    Dim dao1 As New DAO_DRUG.ClsDBdrrgt
        ...
        'dao2.GetDataby_FKIDA(dao1.fields.IDA)
        'dt = bao.SP_DRRGT_EQTO_BY_FK_IDA(_IDA_DR)
        dt = bao.SP_DRRGT_EQTO_BY_FK_IDA(_IDA_EQ)
        'Else
        '    dt = bao.SP_DRRQT_EQTO_BY_FK_IDA(_IDA_DR)
        'End If

        rg_chem_OLD.DataSource = dt
    End Sub
    ...
    Private Sub btn_back_Click(sender As Object, e As EventArgs) Handles btn_back.Click
        Dim url As String = ""
        'If Request.QueryString("e") <> "" Then
        url = "../HERB_TABEAN_NEW_EDIT_STAFF/POPUP_TABEAN_NEW_EDIT_STAFF_ADD_DATA.aspx?IDA=" & _IDA & "&process_id=" & _Process_ID & "&IDA_LCN=" & _IDA_LCN & "&IDA_DR=" & _IDA_DR
        'Else
