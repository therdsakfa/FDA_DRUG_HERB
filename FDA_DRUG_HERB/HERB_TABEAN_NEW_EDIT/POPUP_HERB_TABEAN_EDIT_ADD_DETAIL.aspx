<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_HERB_TABEAN_EDIT_ADD_DETAIL.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_HERB_TABEAN_EDIT_ADD_DETAIL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="row" id="P1" runat="server">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-10">
                                <h3 style="text-align: center">รายละเอียดการแก้ไขเปลี่ยนแปลงรายการในใบสำคัญการขึ้นทะเบียนตำรับผลิตภัณฑ์สมุนไพร</h3>
                            </div>
                            <div class="col-lg-1"></div>
                        </div>
                            ...
                            <div class="col-lg-10" style="padding-left: 2em">
                                ...
                                <div id="Div_NAME_LOCATION" runat="server" style="padding-left: 2em" visible="false">
                                    ...
                                    <asp:Panel ID="Panel_cheng_Location" runat="server" Style="display: none;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_lcnno_display_new" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_lcntpcd_new" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_name_thanm" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_name_location" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_Full_addr" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                    </asp:Panel>
                                    ...
                                    <asp:Panel ID="Panel_cheng_Location2" runat="server" Style="display: none;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_lcnno_display2" runat="server" Text="Label" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_lcntpcd2" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_lcnno_display_new2" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_lcntpcd_new2" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_name_thanm2" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_name_location2" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
                                                <asp:Label ID="lbl_Full_addr2" runat="server" Text="" Width="100%"></asp:Label>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                    </asp:Panel>
                                ...
                                <asp:Panel ID="PANEL_ETIQUETQ" runat="server" Style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-1"></div>
                                        <div class="col-lg-10" style="color: red">
                                            <h4>สามารถแนบเอกสารใหม่ในหน้าถัดไปหลังจากกด "บันทึกข้อมูล"</h4>
                                        </div>
                                        <div class="col-lg-1"></div>
                                    </div>
                                    <%--  <div class="row">
                                ...
                                <asp:Panel ID="Panel_OTHER" runat="server" Style="display: none;">
                                    <asp:Panel runat="server" ID="Panel_Other_CC_Thanm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:TextBox ID="LICENLOCA_IDEN_N" runat="server" Width="100%"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-2" style="text-align: left">
                                                <asp:Button ID="btn_serach_iden_licen" runat="server" Text="ค้นหา" />
                                            </div>
                                        </div>
    ...
    <div class="row" id="E1" runat="server">
        <div class="col-lg-12" style="text-align: center">
            ...
            &ensp;
            <asp:Button ID="btn_save" runat="server" Text="บันทึกข้อมูล" Height="40px" Width="135px" OnClientClick="return confirm('กรุนาตรวจความถูกต้องของข้อมูลก่อนบันทึก');" />
        </div>
    </div>
    <%--</div>
    </div>--%>
