<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_UPLOAD_SPC_PI_PIL.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_UPLOAD_SPC_PI_PIL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <img src="../imgs/spinner.gif" alt="Loading" style="position: absolute; top: 120px; left: 293px; height: 185px; width: 207px;" />
     ...
     <div style="width:100% ; text-align:left"  >
         ...
         <table class="table" style="width:100%;"> <tr><td style="width:15%;"> <asp:Label ID="Label1" runat="server" Text="-"></asp:Label>
