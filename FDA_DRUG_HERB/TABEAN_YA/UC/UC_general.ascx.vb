...
Public Class UC_general
    ...
    Sub update_data(ByVal IDA As Integer)
        ...
        new_data = "ประเภทของยา :" & rcb_drclass.SelectedValue & ", หมวดยา : " & rcb_dactg.SelectedValue & ", รูปแบบยา : " & rcb_drdosage.SelectedValue & ", ชื่อการค้า (ภาษาไทย) : " & txt_thaname.Text & ", ชื่อการค้า (ภาษาอังกฤษ) : " & _
            txt_engname.Text & " ,ชนิดยา : " & rcb_drug_type.SelectedValue & ", รูปทรง : " & dao.fields.DRUG_STYLE & ", หน่วยนับตามรูปของแบบยา : " & rcb_small_unit.SelectedValue & _
            " ,ความแรง : " & txt_drug_str.Text & " , หน่วยนับทางชีวภาพ : " & rcb_bio_pack.SelectedValue & " ,หน่วยนับตามบรรจุภัณฑ์ : " & rcb_packaging.SelectedValue
        ...
        'filename = "drrgt_" & dao.fields.TR_ID & "_" & max_no + 1 & ".xml"
