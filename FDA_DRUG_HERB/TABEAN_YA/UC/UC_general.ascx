<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_general.ascx.vb" Inherits="FDA_DRUG_HERB.UC_general" %>
...
<table>
   ...
   <tr>
        ...
        <td >
            &nbsp;</td>
        <td >
            <asp:TextBox ID="txt_thaname" runat="server" Width="100%" CssClass="input-lg"></asp:TextBox>
        </td>
    </tr>
   ...
   <tr>
        ...
        <td >
            &nbsp;</td>
        <td >
            <asp:TextBox ID="txt_engname" runat="server" Width="100%" CssClass="input-lg"></asp:TextBox>
        </td>
    </tr>
...
<%--    <tr>
   ...
   <tr>
        ...
        <td >
            &nbsp;</td>
        <td >
            <asp:TextBox ID="txt_drug_str" runat="server" Width="100%" CssClass="input-lg"></asp:TextBox>
        </td>
    </tr>
