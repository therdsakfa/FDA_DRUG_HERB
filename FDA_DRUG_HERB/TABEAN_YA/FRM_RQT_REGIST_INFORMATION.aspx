<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_RQT_REGIST_INFORMATION.aspx.vb" ValidateRequest="false" Inherits="FDA_DRUG_HERB.FRM_RQT_REGIST_INFORMATION" %>
...
<%@ Register src="UC/UC_DRUG_DOCUMENT_UPLOAD.ascx" tagname="UC_DRUG_DOCUMENT_UPLOAD" tagprefix="uc18" %>
...
<%--            <telerik:RadTab runat="server" Text="12.รูปแบบการเก็บรักษา">
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="fa left">
        <telerik:RadPageView ID="RadPageView1" runat="server" TabIndex="1">
            ...
            <asp:Button ID="btn_update_gen" runat="server" Text="บันทึกข้อมูลที่แก้ไข" CssClass="input-lg" />
            <br />
        ...
        <telerik:RadPageView ID="RadPageView2" runat="server" TabIndex="2">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="70%">
                        <asp:TextBox ID="txt_package" runat="server" Height="300px" TextMode="MultiLine" Width="100%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
 ...
 <br />
        ...
        <telerik:RadPageView ID="RadPageView15" runat="server" TabIndex="15">
            ...
            <uc18:UC_DRUG_DOCUMENT_UPLOAD ID="UC_DRUG_DOCUMENT_UPLOAD1" runat="server" />
