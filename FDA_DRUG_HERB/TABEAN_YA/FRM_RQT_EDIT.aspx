<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_RQT_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_RQT_EDIT" %>
    ...
    <table class="table">
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td>
                <asp:Button ID="btn_save_edit_des" runat="server" Text="บันทึก" />
            </td>
        </tr>
    </table>
    <hr />
...
<%--            <telerik:RadTab runat="server" Text="12.รูปแบบการเก็บรักษา">
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" CssClass="fa left">
        <telerik:RadPageView ID="RadPageView1" runat="server" TabIndex="1">
            ...
            <asp:Button ID="btn_update_gen" runat="server" Text="บันทึกและแก้ไขข้อมูล" CssClass="input-lg" />
            <br />
