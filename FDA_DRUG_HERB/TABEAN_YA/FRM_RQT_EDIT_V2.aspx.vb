...
Public Class FRM_RQT_EDIT_V2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Request.QueryString("ida_e") <> "" Then
                ...
                txt_old.Text = dao.fields.EDIT_OLD_DESCRIPTION
                txt_new.Text = dao.fields.EDIT_NEW_DESCRIPTION
            End If
        End If
    End Sub
    Sub Run_section1()
    ...
    Protected Sub btn_save_edit_des_Click(sender As Object, e As EventArgs) Handles btn_save_edit_des.Click
        If Request.QueryString("ida_e") <> "" Then
            ...
            dao.fields.EDIT_OLD_DESCRIPTION = txt_old.Text
            dao.fields.EDIT_NEW_DESCRIPTION = txt_new.Text
            dao.update()
            alert("บันทึกรียบร้อยแล้ว")
        End If
    End Sub
    
    Protected Sub btn_send_edit_Click(sender As Object, e As EventArgs) Handles btn_send_edit.Click
        Dim dao As New DAO_DRUG.TB_DRRGT_EDIT_REQUEST
        dao.GetDatabyIDA(Request.QueryString("ida_e"))
        Dim dao_rg As New DAO_DRUG.ClsDBdrrgt
        Try
