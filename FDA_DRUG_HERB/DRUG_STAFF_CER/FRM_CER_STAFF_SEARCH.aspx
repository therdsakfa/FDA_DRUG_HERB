<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_CER_STAFF_SEARCH.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_CER_STAFF_SEARCH" %>
    ...
    <div>
        ...
        <table style="width: 100%;" class=" table">
            ...
            <tr>
                <td>เลขดำเนินการ</td>
                <td>
                    <asp:TextBox ID="txt_TR_ID" runat="server" CssClass="input-sm" Width="200px"></asp:TextBox>
                </td>
       ...
       <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="true" PageSize="15">
                                <MasterTableView autogeneratecolumns="False">
                                    <Columns>
                                        ...
                                        <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_remark" CommandName="remark" Text="เหตุผล">
