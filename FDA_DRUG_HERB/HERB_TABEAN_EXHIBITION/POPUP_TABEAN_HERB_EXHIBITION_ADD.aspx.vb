Public Class POPUP_TABEAN_HERB_EXHIBITION_ADD
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        Try
            ...
            TR_ID = bao_tran.insert_transection(20910)
        ...
        dao_up_mas.GetdatabyID_TYPE(210)
    ...
    Sub alert_summit(ByVal text As String, ByVal ida As Integer)
        Dim url As String = ""
        url = "POPUP_TABEAN_HERB_EXHIBITION_UPLOAD.aspx?IDA=" & ida & "&PROCESS_ID=" & _PROCESS_ID & "&IDA_LCN=" & _IDA_LCN
