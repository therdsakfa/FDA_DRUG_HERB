...
Public Class FRM_TABEAN_HERB_EXHIBITION
    ...
    Protected Sub btn_add_tabean_Click(sender As Object, e As EventArgs) Handles btn_add_tabean.Click
        ...
        dao.insert()
        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & " POPUP_TABEAN_HERB_EXHIBITION_ADD.aspx?IDA=" & dao.fields.IDA & "&PROCESS_ID=" & _PROCESS_ID & "&IDA_LCN=" & _IDA_LCN & "');", True)
    End Sub

    Function bind_data()
        Dim bao As New BAO.ClsDBSqlcommand
        Dim dt As DataTable
        dt = bao.SP_TABEAN_EXHIBITION_CUSTOMER(_IDA_LCN, _CLS.CITIZEN_ID_AUTHORIZE)
        Return dt
        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "HL_SELECT" Then
                If STATUS_ID = 11 Then
                    ...
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & " POPUP_TABEAN_HERB_EXHIBITION_EDIT_REQUEST.aspx?IDA_DR=" & _IDA_DR & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & IDA & "&IDA_LCN=" & _IDA_LCN & "');", True)
                Else
