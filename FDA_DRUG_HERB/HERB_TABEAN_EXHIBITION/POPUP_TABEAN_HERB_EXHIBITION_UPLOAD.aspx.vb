Public Class POPUP_TABEAN_HERB_EXHIBITION_UPLOAD
    ...
    Sub alert_normal(ByVal text As String)
        Dim url As String = ""
        url = "FRM_TABEAN_HERB_EXHIBITION.aspx?IDA_LCT=" & _IDA_LCT & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA & "&SID=" & _SID
    ...
    Sub alert_file_error(ByVal text As String)
        Dim url As String = ""
        url = "POPUP_TABEAN_HERB_EXHIBITION_UPLOAD.aspx?IDA_LCT=" & _IDA_LCT & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA & "&SID=" & _SID
