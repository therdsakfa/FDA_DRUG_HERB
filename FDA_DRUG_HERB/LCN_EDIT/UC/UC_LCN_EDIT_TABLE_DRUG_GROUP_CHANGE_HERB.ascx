<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_LCN_EDIT_TABLE_DRUG_GROUP_CHANGE_HERB.ascx.vb" Inherits="FDA_DRUG_HERB.UC_LCN_EDIT_TABLE_DRUG_GROUP_CHANGE_HERB" %>
