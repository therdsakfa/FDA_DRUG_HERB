<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="DRUG_REQUEST_CENTER_INSERT_V2.aspx.vb" Inherits="FDA_DRUG_HERB.DRUG_REQUEST_CENTER_INSERT_V2" %>
       ...
       <div >
        ...
        <h4> <asp:Label ID="lbl_systemID" runat="server" Text=""></asp:Label></h4>
           ...
           <asp:Panel ID="Panel1" runat="server" GroupingText="">
                   ...
                   <tr>
                            <td Width="30%">เลขอ้างอิง <font color="red">*</font> <br />
                                (กรุณาพิมพ์และกดตรวจสอบเลขอ้างอิง)
                            </td>
                            <td >
                                <asp:TextBox ID="txt_refno" runat="server" CssClass="input-sm" Width="200px"></asp:TextBox>
                                <asp:Button ID="btn_" runat="server" Text="ตรวจสอบ" CssClass="btn-lg"/>
                                <br />
