<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_Auto_Menu.Master" CodeBehind="DRUG_REQUEST_BY_CUSTOMER_MAIN.aspx.vb" Inherits="FDA_DRUG_HERB.DRUG_REQUEST_BY_CUSTOMER_MAIN" %>
     ...
     <script type="text/javascript" >
         $(document).ready(function () {
             $('#ContentPlaceHolder1_btn_add').click(function () {
                 Popups('../DRUG_REQUEST_CENTER/DRUG_REQUEST_CENTER_INSERT_CUSTOMER.aspx');
                 return false;
             });
...
<MasterTableView autogeneratecolumns="False" datakeynames="IDA">
    ...
    <Columns>
       ...
       <telerik:GridBoundColumn DataField="TRADENAME" FilterControlAltText="Filter TRADENAME column" 
        ...
        <%--<telerik:GridButtonColumn  ButtonType="LinkButton" UniqueName="_pay" CommandName="_pay" Text="ชำระเงิน" >
                        <HeaderStyle Width="70px" />
              </telerik:GridButtonColumn>--%>
        <telerik:GridTemplateColumn UniqueName="_pay">
            <ItemTemplate>
                <asp:HyperLink ID="hp1" runat="server" Target="_blank">ชำระเงิน</asp:HyperLink>
            </ItemTemplate>
            <HeaderStyle Width="70px" />
