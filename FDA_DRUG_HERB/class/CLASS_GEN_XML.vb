...
#End Region
        Public Function XML_APOINTMENT() As CLASS_APPOINTMENT
            ...
            ElseIf process_id = 60303 Then
                PROCESS_NAME = "การพิจารณาความถูกต้องและแปลเอกสารอื่นๆ"
            ElseIf process_id = 21410 Then
