...
Namespace BAO
    ...
    Public Class ClsDBSqlcommand
        ...
        End Function
        '
        Public Function SP_drug_general_sai_v2(ByVal newcode As String) As DataTable
            Dim sql As String = "exec SP_drug_general_sai_v2 @newcode='" & newcode & "'"
            Dim dta As New DataTable
            dta = Queryds(sql)
            dta.TableName = "SP_drug_general_sai"
            Return dta
    ...
    Public Class CAL_DATE
        ...
        Public Function chk_limit_DRUG(ByVal process_id As String, ByVal SYSTEM_ID As String, ByVal t_date As Date, ByVal num As Integer) As Boolean
            ...
            'Dim ws_date As New WS_GETDATE_WORKING.BasicHttpBinding_IService1
