Namespace XML_CENTER
    Public Class CLASS_DALCN_SUBSTITUTE
        Inherits CLASS_CENTER
        Public DALCN_SUBSTITUTEs As New DALCN_SUBTITUTE
#Region "SHOW"
...
#Region "additional"
        ...
        Public Property TEL() As String
            ...
            End Set
        End Property
        Private _LCNNO_FORMAT_NEW As String
        Public Property LCNNO_FORMAT_NEW() As String
            Get
                Return _LCNNO_FORMAT_NEW
            End Get
            Set(ByVal value As String)
                _LCNNO_FORMAT_NEW = value
            End Set
        End Property
        '
        ...
        Private _PUR_POSE As String
        Public Property PUR_POSE() As String
            Get
                Return _PUR_POSE
            End Get
            Set(ByVal value As String)
            ...
            End Set
        End Property
        Private _WTIRE_DATE As String
        Public Property WTIRE_DATE() As String
            Get
                Return _WTIRE_DATE
            End Get
            Set(ByVal value As String)
