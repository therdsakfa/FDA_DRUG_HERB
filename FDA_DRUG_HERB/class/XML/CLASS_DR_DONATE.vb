Public Class CLASS_DR_DONATE
    Inherits CLASS_CENTER
    Public TABEAN_DONATE As New TABEAN_DONATE
...
#End Region
    ...
    Public Property RCVDATE_FULL_THAI() As String
        ...
        End Set
    End Property
    Private _DONATEDATE_FULL_TH As String
    Public Property DONATEDATE_FULL_THAI() As String
        Get
            Return _DONATEDATE_FULL_TH
        End Get
        Set(ByVal value As String)
            _DONATEDATE_FULL_TH = value
        End Set
    End Property
