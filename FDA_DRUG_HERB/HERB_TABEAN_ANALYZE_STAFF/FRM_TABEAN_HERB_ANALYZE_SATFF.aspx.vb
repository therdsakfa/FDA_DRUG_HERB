...
Public Class FRM_TABEAN_HERB_ANALYZE_SATFF
    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "sel" Then
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_TABEAN_HERB_ANALYZE_CONFIRM_STAFF.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&IDA_LCN=" & IDA_LCN & "&TR_ID=" & TR_ID & "');", True)
            End If
    ...
    Private Sub RadGrid1_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        Try
            dt = bao.SP_TABEAN_ANALYZE_STAFF()
        Catch ex As Exception
