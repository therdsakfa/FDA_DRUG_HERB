<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_TABEAN_HERB_ANALYZE_SATFF.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_TABEAN_HERB_ANALYZE_SATFF" %>
    ...
    <div class="panel" style="text-align: left; width: 100%">
        <div class="panel-heading panel-title" style="height: 70px">
            ...
            <div class="col-lg-4 col-md-4">
                <h4>คำขอผลิตภัณฑ์สมุนไพรเพื่อการวิเคราะห์</h4>
            </div>
