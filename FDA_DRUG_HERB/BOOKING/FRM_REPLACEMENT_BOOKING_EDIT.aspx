<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF_MAIN.Master" CodeBehind="FRM_REPLACEMENT_BOOKING_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_REPLACEMENT_BOOKING_EDIT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <uc1:UC_DRUG_SEARCH runat="server" ID="UC_DRUG_SEARCH" />
       ...
       <MasterTableView>
           ...
           <asp:Button ID="lbn_edit_CONSIDER_DATE" Width="100%" runat="server" CssClass="btn-info btn-sm" BackColor="Goldenrod" Text="แก้ไขวันที่ส่งเอกสาร" CommandName="edit_CONSIDER_DATE" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' /> 
           <asp:Button ID="lbn_edit_ALLOW_DATE" Width="100%" runat="server" CssClass="btn-info btn-sm" BackColor="Goldenrod" Text="แก้ไขวันที่ฟังผลการตรวจรับ" CommandName="edit_ALLOW_DATE" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' /> 
                 </ItemTemplate>
            ...
            <Columns>
               ...
               <asp:BoundField HeaderText="วันที่" DataField="SCHEDULE_DATE" DataFormatString="{0:d}" ItemStyle-Width="5%" HeaderStyle-HorizontalAlign="Center"  />
                ...
                <asp:BoundField HeaderText="ฝ่าย" DataField="WORK_GROUP_NAME" ItemStyle-Width="5%" HeaderStyle-HorizontalAlign="Center" />
                 <asp:BoundField HeaderText="วันที่นัด" DataField="CONSIDER_DATE_DISPLAY"  ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                ...
                <asp:BoundField HeaderText="เลขอ้างอิง R" DataField="REF_R_NUMBER_1"  ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" />
                  <asp:TemplateField>
                    <ItemTemplate>
                         <asp:Button ID="lbn_edit_date" Width="100%" runat="server" CssClass="btn-info" BackColor="Goldenrod" Text="แก้ไขวันที่นัด" CommandName="edit_date" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' /> 
                 </ItemTemplate>
