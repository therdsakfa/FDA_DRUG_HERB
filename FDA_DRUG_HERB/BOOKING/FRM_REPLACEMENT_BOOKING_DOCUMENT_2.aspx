<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/POPUP.Master" CodeBehind="FRM_REPLACEMENT_BOOKING_DOCUMENT_2.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_REPLACEMENT_BOOKING_DOCUMENT_2" %>
        ...
        <tr>
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <asp:Button ID="btn_load" runat="server" CssClass="btn-lg" Text="Download PDF" Width="80%" />
