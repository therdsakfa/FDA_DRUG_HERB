<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF_DRUG_POPUP.Master" CodeBehind="FRM_REPLACEMENT_DRUG_BOOKING_VISITOR.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_REPLACEMENT_DRUG_BOOKING_VISITOR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="table" style="width:100%;">
        <tr>
            ...
            <td style="width:25%;">ชื่อผู้มาติดต่อ</td>
            <td style="width:25%;">
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        <telerik:GridBoundColumn DataField="lcnsid" DataType="System.Int32" FilterControlAltText="Filter lcnsid column" HeaderText="lcnsid" 
         ...
         <telerik:GridBoundColumn DataField="fullname2" FilterControlAltText="Filter fullname2 column" HeaderText="ชื่อผู้มาติดต่อ" ReadOnly="True" SortExpression="fullname2" UniqueName="fullname2">
            <ColumnValidationSettings>
                <%--<ModelErrorMessage Text="" />--%>
            </ColumnValidationSettings>
        </telerik:GridBoundColumn>
