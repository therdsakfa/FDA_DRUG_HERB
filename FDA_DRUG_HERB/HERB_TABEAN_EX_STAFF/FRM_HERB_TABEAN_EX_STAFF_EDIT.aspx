<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_EX_STAFF_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_EX_STAFF_EDIT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-5" style="padding-left: 4em">
            <asp:CheckBox ID="CHK_EX1_EDIT" runat="server" AutoPostBack="True" />
    ...
    <div class="row" runat="server" id="DIV_SHOW_TXT_EDIT_EX1" visible="false">
        <%--<div class="row">
            <div class="col-lg-12" style="text-align: center">
