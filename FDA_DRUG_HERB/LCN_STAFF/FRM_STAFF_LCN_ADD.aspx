<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_LCN_ADD.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_LCN_ADD" %>
  ...
  <img src="../imgs/spinner.gif" alt="Loading" style="position: absolute; top: 120px; left: 293px; height: 185px; width: 207px;" />
     ...
     <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2>เพิ่มข้อมูลใบอนุญาตสถานที่ด้านยา สำหรับเจ้าหน้าที่</h2>
                   ...
                   <Columns>
                      ...
                      <%-- <telerik:GridBoundColumn DataField="HOUSENO" FilterControlAltText="Filter HOUSENO column"
                       ...
                       <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_drug_group"
                           CommandName="drug_group" Text="รายละเอียดหมวดยา">
