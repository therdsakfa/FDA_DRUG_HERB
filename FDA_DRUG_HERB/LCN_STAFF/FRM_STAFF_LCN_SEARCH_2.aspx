<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_STAFF_LCN_SEARCH_2.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_LCN_SEARCH_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2>ค้นหาใบอนุญาตสถานที่ด้านผลิตภัณฑ์สมุนไพร สำหรับเจ้าหน้าที่</h2>
        </div>
    </div>
    <hr />
    <div>
    ...
    <div class=" modal fade" id="myModal">
        <div class="panel panel-info" style="width: 100%;">
            <div class="panel-heading  text-center">
                <h1>ใบอนุญาตต่ออายุสถานที่ด้านยา </h1>
            </div>
