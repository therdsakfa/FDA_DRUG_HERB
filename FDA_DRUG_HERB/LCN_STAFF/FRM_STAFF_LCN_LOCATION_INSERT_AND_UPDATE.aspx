<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_STAFF_LCN_LOCATION_INSERT_AND_UPDATE.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_STAFF_LCN_LOCATION_INSERT_AND_UPDATE" %>
