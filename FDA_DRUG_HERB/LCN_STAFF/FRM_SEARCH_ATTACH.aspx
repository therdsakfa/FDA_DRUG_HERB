<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_SEARCH_ATTACH.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_SEARCH_ATTACH" %>
  ...
  <img src="../imgs/spinner.gif" alt="Loading" style="position: absolute; top: 120px; left: 293px; height: 185px; width: 207px;" />
     ...
     <div>
        <div class="panel-heading panel-title" style="padding-left: 5%;">
            <h2>ค้นหาใบอนุญาตสถานที่ด้านยา สำหรับอัพโหลดไฟล์เพิ่มเติม</h2>
               ...
               <MasterTableView AutoGenerateColumns="False">
                   <Columns>
                       ...
                       <telerik:GridButtonColumn ButtonType="LinkButton" UniqueName="btn_Select"
                           CommandName="sel" Text="รายการไฟล์แนบ">
