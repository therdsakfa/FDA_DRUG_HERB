           ...
           <table>
            ...
            <td style="padding-left: 10%; height: 50%;">
                ...
                <table class="table" style="width: 90%">
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btn_preview" runat="server" Text="Preview ใบอนุญาต" CssClass="btn-lg" Width="80%" /></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Button ID="btn_dbd" runat="server" Text="ข้อมูล DBD" CssClass="btn-lg bg-primary" Width="80%" /></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btn_drug_group" runat="server" Text="หมวดยา" CssClass="btn-lg" Style="display: none;" Width="80%" /></td>
                    </tr>
