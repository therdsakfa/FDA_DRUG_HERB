        ...
        <div class="panel-body">
            <table class="table">
                ...
                <tr>
                    <td>ชื่อผู้ลงนาม </td>
                    <td>
                        <%--<asp:DropDownList ID="ddl_staff_offer" runat="server" DataTextField="STAFF_OFFER_NAME" DataValueField="IDA" CssClass="input-lg" Width="200px" Filter="Contains"></asp:DropDownList>--%>
                        <telerik:RadComboBox ID="ddl_staff_offer" runat="server" Filter="Contains" Width="200px"></telerik:RadComboBox>
                    </td>
                </tr>
                <tr>
                    <td>วันที่เสนอลงนาม</td>
                    <td>
                        <asp:TextBox ID="TextBox1" runat="server" class="input-lg"></asp:TextBox></td>
                </tr>
