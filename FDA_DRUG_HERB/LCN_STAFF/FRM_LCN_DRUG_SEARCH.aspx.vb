...
Public Class FRM_LCN_DRUG_SEARCH
    ...
    Sub Search_FN()
        ...
        ElseIf txt_tr_id.Text <> "" Then
            ...
            If tr_id <> 0 Then
                If str_where <> "" Then
                    str_where &= " and TR_ID =" & tr_id
                Else
                    str_where &= " TR_ID =" & tr_id
                End If
            End If
        ElseIf txt_identify.Text <> "" Then
            If str_where <> "" Then
                str_where &= " and CITIZEN_ID_AUTHORIZE ='" & txt_identify.Text & "'"
            Else
                str_where &= " CITIZEN_ID_AUTHORIZE = '" & txt_identify.Text & "'"
            End If
        End If
        ' pvncd = 12
        If pvncd <> 10 Then
