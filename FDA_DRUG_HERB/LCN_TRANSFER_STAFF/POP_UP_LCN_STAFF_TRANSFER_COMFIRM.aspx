<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POP_UP_LCN_STAFF_TRANSFER_COMFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.POP_UP_LCN_STAFF_TRANSFER_COMFIRM" %>
        ...
        <div class="col-lg-4" style="width: 30%">
                ...
                <div class="row" runat="server" id="P12" visible="true">
                    ...
                    <div class="row" runat="server">
                        ...
                        <div class="col-lg-6">
                            ...
                            <asp:DropDownList ID="DD_OFF_REQ" runat="server" DataValueField="IDA" DataTextField="STAFF_NAME"  Style="width: 100%"  AutoPostBack="true"></asp:DropDownList>
                        </div>
                        <div class="col-lg-1"></div>
                    </div>
                </div>
            ...
            <div class="row" style="text-align: center">
               ...
               <div class="row" style="text-align: center">
                <div class="col-lg-1"></div>
                <div class="col-lg-10">
                   <asp:Button ID="btn_sormorpo1" runat="server" Text="Preview ใบอนุญาต(สมพ1)" CssClass="btn-lg" Width="80%" Visible="false" />
                </div>
                <div class="col-lg-1"></div>
            </div>
