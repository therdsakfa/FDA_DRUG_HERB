Public Class FRM_REPORT_LCN_DRUG
    ...
    Sub load_GV_lcnno()
        ...
        GV_lcnno.DataSource = bao.SP_STAFF_DALCN_REPORT()
        GV_lcnno.DataBind()
    End Sub
...
#Region "GRIDVIEW"
    ...
    Protected Sub GV_lcnno_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GV_lcnno.RowCommand
        ...
        If e.CommandName = "sel" Then
            ...
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "FRM_REPORT_LCN_CONFIRM.aspx?IDA=" & str_ID & "&TR_ID=" & tr_id & "&process=" & dao_pro.fields.PROCESS_ID & "');", True)
