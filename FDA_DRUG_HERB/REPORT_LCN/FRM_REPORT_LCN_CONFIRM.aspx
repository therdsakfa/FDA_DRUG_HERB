<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_REPORT_LCN_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_REPORT_LCN_CONFIRM" %>
            ...
            <td rowspan="2" style="width:70%;">
             ...
             <td style="padding-left:10%;height:50%;">
                 ...
                 <table class="table" style="width:90%"> 
                     ...
                     <tr><td>  <asp:Button ID="btn_load" runat="server" Text="Dowload PDF" CssClass="btn-lg"   Width="80%" /></td></tr>
