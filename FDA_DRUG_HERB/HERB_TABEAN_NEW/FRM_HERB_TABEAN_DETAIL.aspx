<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_HERB_TABEAN_DETAIL.aspx.vb" MaintainScrollPositionOnPostback="true" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_DETAIL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="NAME_TB" runat="server" ReadOnly="true" ></asp:TextBox>
        </div>
        <div class="col-lg-2">
            <label>ชื่อสถานที่:</label>
        </div>
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="NAME_PLACE_TB" runat="server" ReadOnly="true" ></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <asp:DropDownList ID="DD_CATEGORY_OUT_ID" runat="server" BackColor="White" Height="25px" Width="100%" SkinID="bootstrap" Enabled="false">
                <asp:ListItem Value="0">-- กรุณาเลือก --</asp:ListItem>
    ...
    <div class="row" id="foreign" runat="server" visible="false">
        ...
        <div class="row">
            ...
            <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
                <asp:TextBox ID="txt_search" runat="server" TextMode="MultiLine" Height="60px" Width="100%"  ReadOnly="true"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
                 <asp:TextBox ID="txt_address" runat="server" TextMode="MultiLine" Height="60px" Width="100%" ReadOnly="true" ></asp:TextBox>
    ...
    <div class="row">
        ...
        <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="NAME_THAI" runat="server" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-2">
            <label>ชื่อภาษาอังกฤษ(ถ้ามี):</label>
        </div>
        <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="NAME_ENG" runat="server" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-3" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="NAME_OTHER" runat="server" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-2">
            <label>รูปแบบ:</label>
        </div>
        <div class="col-lg-2">
            <asp:DropDownList ID="DD_STYPE_ID" runat="server" DataValueField="STYPE_ID" DataTextField="STYPE_NAME" BackColor="White" Height="25px" Width="200px" Enabled="false" SkinID="bootstrap"></asp:DropDownList>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="SIZE_PACK" runat="server"   TextMode="MultiLine" Height="60px" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="NATURE" runat="server" TextMode="MultiLine" Height="60px" Width="100%" ReadOnly="true" ></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
    ...
    <%--<div class="row">
        ...
        <div class="col-lg-3"> <asp:TextBox ID="NO_ID" runat="server" Width="100%" TextMode="Number" ></asp:TextBox></div>
    ...
    <%--<div class="row">
        ...
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="WEIGHT_TABLE_CAP" runat="server" TextMode="Number" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-2">หน่วย</div>
        <div class="col-lg-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="PROPERTIES" runat="server" ReadOnly="true"  TextMode="MultiLine" Height="60px" Width="100%"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="SIZE_USE" runat="server"  ReadOnly="true" TextMode="MultiLine" Height="60px" Width="100%"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="HOW_USE" runat="server" ReadOnly="true" ></asp:TextBox>
        </div>
        <div class="col-lg-2">
            <label>วิธีเตรียมก่อนรับประทาน:</label>
        </div>
        <div class="col-lg-2">
            <asp:DropDownList ID="DD_EATTING_ID" runat="server" DataValueField="EATTING_ID" DataTextField="EATTING_NAME" BackColor="White" Height="25px" Width="100%" SkinID="bootstrap" AutoPostBack="true" Enabled="false">
                <%--<asp:ListItem Value="0">-- กรุณาเลือก --</asp:ListItem>
        ...
        <div class="col-lg-6" id="R_EATTING_TEXT" runat="server" visible="false">
            <asp:TextBox ID="EATTING_TEXT" runat="server" TextMode="MultiLine" Height="60px" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            ...
            <asp:DropDownList ID="DD_EATING_CONDITION_ID" runat="server" DataValueField="PRO_CON_ID" DataTextField="PRO_CON_NAME" BackColor="White" Height="25px" Width="100%" SkinID="bootstrap" AutoPostBack="true" Enabled="false"></asp:DropDownList>
        </div>
    ...
    <div class="row">
        ...
        <%--<div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="TREATMENT" runat="server" Width="200px" ReadOnly="true"></asp:TextBox>
        </div>--%>
        <div class="col-lg-2">
        ...
        <div class="col-lg-1" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="TREATMENT_AGE" runat="server" TextMode="Number" Width="100px" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1">
    ...
    <div class="row">
        ...
        <div class="col-lg-6" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="NOTE" runat="server"   TextMode="MultiLine" Height="60px" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <hr />
