<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_EDIT_2.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_EDIT_2" %>
    ...
    <div id="EDIT_TB1_SHOW" runat="server" visible="false">
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    <div class="col-lg-12" style="text-align: center;">
                        <asp:TextBox ID="TXT_EDIT_NOTE_TB1" TextMode="MultiLine" runat="server" Style="height: 50%; width: 75%;" ForeColor="#FF3300"></asp:TextBox>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
            </div>
